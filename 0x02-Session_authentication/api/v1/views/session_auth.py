...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/wp-runtime-715bba30fc8c.js"></script>
...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>alx-backend-user-data/0x02-Session_authentication/api/v1/views/session_auth.py at main · Innocentsax/alx-backend-user-data · GitHub</title>
  ...
  <meta name="request-id" content="CCC6:307407:27DB933:287F51D:66EC8FE6" data-pjax-transient="true"/><meta name="html-safe-nonce" content="629da8e5179e29217632b22338414d53835ef21c05a8d21d0fe2f9fdccbfd6bd" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJDQ0M2OjMwNzQwNzoyN0RCOTMzOjI4N0Y1MUQ6NjZFQzhGRTYiLCJ2aXNpdG9yX2lkIjoiMjcxNzU4OTI4OTI0NjE2NzAxNCIsInJlZ2lvbl9lZGdlIjoiZnJhIiwicmVnaW9uX3JlbmRlciI6ImZyYSJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="a62d5d80e167253d14b819748c2d6136282be2ceb3b40950eb7af0d1af7573e2" data-pjax-transient="true"/>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - alx-backend-user-data/0x02-Session_authentication/api/v1/views/session_auth.py at main · Innocentsax/alx-backend-user-data">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="alx-backend-user-data/0x02-Session_authentication/api/v1/views/session_auth.py at main · Innocentsax/alx-backend-user-data" /><meta name="twitter:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  <meta property="og:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta property="og:image:alt" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="alx-backend-user-data/0x02-Session_authentication/api/v1/views/session_auth.py at main · Innocentsax/alx-backend-user-data" /><meta property="og:url" content="https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py" /><meta property="og:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  ...
  <meta http-equiv="x-pjax-version" content="bb5543a2bc7ce8299b6266c923669515504f8e6d9454efe6b768bfc322a91549" data-turbo-track="reload">
  ...
  <meta http-equiv="x-pjax-js-version" content="bd86d1a6453804b0a1256e753aa47fab3b4b9432257039465f6b11d2a700fd56" data-turbo-track="reload">
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x02-Session_authentication%2Fapi%2Fv1%2Fviews%2Fsession_auth.py"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="efe5b541ed8861661d4d65a14421db51e11f38ab9e7c0b06513f05550d73c2e5"
...
<qbsearch-input class="search-input" data-scope="repo:Innocentsax/alx-backend-user-data" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="Tt9IOTGUcuCVUgcZEcG7eOxRCgAx1he5cTZWogjlKZgyhAVacz8aFWKOK3UKMcxbYnPRST5uny-snj_i-Mb7uA" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Innocentsax/alx-backend-user-data" data-current-org="" data-current-owner="Innocentsax" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-4035ddca-ee90-4787-9623-11edcd9653bf" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-4035ddca-ee90-4787-9623-11edcd9653bf" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="OMHkzUFpU79vTcyyraSI75mr/3KMlHM2OViVRcorHtmogm4VVhilZM2P0tEAc/JcGNmNWezEKrdFkAKF2EG1RA==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="Gw1aBLXrWEZqB9Z4NHyH0RLUmFfuwM/ToKytZFlo03c7x8esdq3b/olSWGmkWls7ojeiyMmydzdEJHhjxQso4g==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="s1RYe9YEnWEmU4sr04cN6QryV/ZamhWbkFLHbAogTQB1sND5uydxZYlraJTs/UTWB9qOfgmIqcxn5D+wNWmxEQ==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-298f25a7-3ec2-466c-9240-388cce125864" aria-labelledby="tooltip-ff2a388c-eca7-4265-a0f0-3350f199e491" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-ff2a388c-eca7-4265-a0f0-3350f199e491" for="icon-button-298f25a7-3ec2-466c-9240-388cce125864" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="90bee558cbf6d73c13ece0452aa47e286a279b16032de89e0430d53ff3309b8e" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-17a70681-cdb4-4fee-83a8-e8b1441e5b58" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

  </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="91101ebe6e9e6bc54498bfb692940f282e6314e921bfc8373cc88ccf6c2e0caf" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="ac5ab7d633e3ff0c603c61c8f3c4611affc161a17b454b79a28b6103ae3f8f4a" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-button" popovertarget="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-overlay" aria-controls="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-list" aria-haspopup="true" aria-labelledby="tooltip-d631006a-968a-4534-ac09-12f8399d05ac" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-d631006a-968a-4534-ac09-12f8399d05ac" for="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-overlay" anchor="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-button" id="action-menu-9b8cc8a7-0918-48f7-9660-0622c1335ec8-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-9118727d-6771-4d14-8e98-93bb6d445070" href="/Innocentsax/alx-backend-user-data" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-37b5aebc-0277-4700-a31d-a56d8ec106fd" href="/Innocentsax/alx-backend-user-data/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-74c38b6e-e8c0-4e46-aa60-6d139c360106" href="/Innocentsax/alx-backend-user-data/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-fc09281f-3e00-4ddf-888d-50b3a6e22fbc" href="/Innocentsax/alx-backend-user-data/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-e18c6ffc-6121-4688-8e3f-619d7d8bf58a" href="/Innocentsax/alx-backend-user-data/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-3c65e77b-e272-45a6-949f-6f7a0f504532" href="/Innocentsax/alx-backend-user-data/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-f86e119f-c8fa-4ce4-8c5b-18428b743421" href="/Innocentsax/alx-backend-user-data/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"0x02-Session_authentication/api/v1/views":{"items":[{"name":"__pycache__","path":"0x02-Session_authentication/api/v1/views/__pycache__","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/api/v1/views/.DS_Store","contentType":"file"},{"name":"__init__.py","path":"0x02-Session_authentication/api/v1/views/__init__.py","contentType":"file"},{"name":"index.py","path":"0x02-Session_authentication/api/v1/views/index.py","contentType":"file"},{"name":"session_auth.py","path":"0x02-Session_authentication/api/v1/views/session_auth.py","contentType":"file"},{"name":"users.py","path":"0x02-Session_authentication/api/v1/views/users.py","contentType":"file"}],"totalCount":6},"0x02-Session_authentication/api/v1":{"items":[{"name":"__pycache__","path":"0x02-Session_authentication/api/v1/__pycache__","contentType":"directory"},{"name":"auth","path":"0x02-Session_authentication/api/v1/auth","contentType":"directory"},{"name":"views","path":"0x02-Session_authentication/api/v1/views","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/api/v1/.DS_Store","contentType":"file"},{"name":"__init__.py","path":"0x02-Session_authentication/api/v1/__init__.py","contentType":"file"},{"name":"app.py","path":"0x02-Session_authentication/api/v1/app.py","contentType":"file"}],"totalCount":6},"0x02-Session_authentication/api":{"items":[{"name":"__pycache__","path":"0x02-Session_authentication/api/__pycache__","contentType":"directory"},{"name":"v1","path":"0x02-Session_authentication/api/v1","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/api/.DS_Store","contentType":"file"},{"name":"__init__.py","path":"0x02-Session_authentication/api/__init__.py","contentType":"file"}],"totalCount":4},"0x02-Session_authentication":{"items":[{"name":"api","path":"0x02-Session_authentication/api","contentType":"directory"},{"name":"models","path":"0x02-Session_authentication/models","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/.DS_Store","contentType":"file"},{"name":"README.md","path":"0x02-Session_authentication/README.md","contentType":"file"},{"name":"requirements.txt","path":"0x02-Session_authentication/requirements.txt","contentType":"file"}],"totalCount":5},"":{"items":[{"name":"0x00-personal_data","path":"0x00-personal_data","contentType":"directory"},{"name":"0x01-Basic_authentication","path":"0x01-Basic_authentication","contentType":"directory"},{"name":"0x02-Session_authentication","path":"0x02-Session_authentication","contentType":"directory"},{"name":"0x03-user_authentication_service","path":"0x03-user_authentication_service","contentType":"directory"},{"name":".DS_Store","path":".DS_Store","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Screenshot 2023-11-01 at 12.58.39 PM.png","path":"Screenshot 2023-11-01 at 12.58.39 PM.png","contentType":"file"}],"totalCount":8}},"fileTreeProcessingTime":9.587788999999999,"foldersToFetch":[],"repo":{"id":712869884,"defaultBranch":"main","name":"alx-backend-user-data","ownerLogin":"Innocentsax","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-11-01T11:22:09.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/117287767?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1698839736.0","canEdit":false,"refType":"branch","currentOid":"465ee6ac460d1eb969bb744c6fa1c3dac0fc78d8"},"path":"0x02-Session_authentication/api/v1/views/session_auth.py","currentUser":null,"blob":{"rawLines":["#!/usr/bin/env python3","\"\"\" Module of Users views","\"\"\"","import os","from api.v1.views import app_views","from models.user import User","from flask import jsonify, request","","","@app_views.route('/auth_session/login', methods=['POST'], strict_slashes=False)","def session_auth():","    \"\"\"_summary_","    \"\"\"","    email = request.form.get('email')","    password = request.form.get('password')","    if email is None or email == '':","        return jsonify({\"error\": \"email missing\"}), 400","    if password is None or password == '':","        return jsonify({\"error\": \"password missing\"}), 400","    users = User.search({\"email\": email})","    if not users or users == []:","        return jsonify({\"error\": \"no user found for this email\"}), 404","    for user in users:","        if user.is_valid_password(password):","            from api.v1.app import auth","            session_id = auth.create_session(user.id)","            resp = jsonify(user.to_json())","            session_name = os.getenv('SESSION_NAME')","            resp.set_cookie(session_name, session_id)","            return resp","    return jsonify({\"error\": \"wrong password\"}), 401","","","@app_views.route('/auth_session/logout',","                 methods=['DELETE'], strict_slashes=False)","def logout():","    \"\"\"","    for logging out user","    \"\"\"","    from api.v1.app import auth","    if auth.destroy_session(request):","        return jsonify({}), 200","    abort(404)"],"stylingDirectives":[[{"s":0,"e":22,"c":"pl-c"}],[{"s":0,"e":25,"c":"pl-s"}],[{"s":0,"e":3,"c":"pl-s"}],[{"s":0,"e":6,"c":"pl-k"},{"s":7,"e":9,"c":"pl-s1"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":8,"c":"pl-s1"},{"s":9,"e":11,"c":"pl-s1"},{"s":12,"e":17,"c":"pl-s1"},{"s":18,"e":24,"c":"pl-k"},{"s":25,"e":34,"c":"pl-s1"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":11,"c":"pl-s1"},{"s":12,"e":16,"c":"pl-s1"},{"s":17,"e":23,"c":"pl-k"},{"s":24,"e":28,"c":"pl-v"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":10,"c":"pl-s1"},{"s":11,"e":17,"c":"pl-k"},{"s":18,"e":25,"c":"pl-s1"},{"s":27,"e":34,"c":"pl-s1"}],[],[],[{"s":0,"e":79,"c":"pl-en"},{"s":1,"e":10,"c":"pl-s1"},{"s":11,"e":16,"c":"pl-en"},{"s":17,"e":38,"c":"pl-s"},{"s":40,"e":47,"c":"pl-s1"},{"s":47,"e":48,"c":"pl-c1"},{"s":49,"e":55,"c":"pl-s"},{"s":58,"e":72,"c":"pl-s1"},{"s":72,"e":73,"c":"pl-c1"},{"s":73,"e":78,"c":"pl-c1"}],[{"s":0,"e":3,"c":"pl-k"},{"s":4,"e":16,"c":"pl-en"}],[{"s":4,"e":16,"c":"pl-s"}],[{"s":0,"e":7,"c":"pl-s"}],[{"s":4,"e":9,"c":"pl-s1"},{"s":10,"e":11,"c":"pl-c1"},{"s":12,"e":19,"c":"pl-s1"},{"s":20,"e":24,"c":"pl-s1"},{"s":25,"e":28,"c":"pl-en"},{"s":29,"e":36,"c":"pl-s"}],[{"s":4,"e":12,"c":"pl-s1"},{"s":13,"e":14,"c":"pl-c1"},{"s":15,"e":22,"c":"pl-s1"},{"s":23,"e":27,"c":"pl-s1"},{"s":28,"e":31,"c":"pl-en"},{"s":32,"e":42,"c":"pl-s"}],[{"s":4,"e":6,"c":"pl-k"},{"s":7,"e":12,"c":"pl-s1"},{"s":13,"e":15,"c":"pl-c1"},{"s":16,"e":20,"c":"pl-c1"},{"s":21,"e":23,"c":"pl-c1"},{"s":24,"e":29,"c":"pl-s1"},{"s":30,"e":32,"c":"pl-c1"},{"s":33,"e":35,"c":"pl-s"}],[{"s":8,"e":14,"c":"pl-k"},{"s":15,"e":22,"c":"pl-en"},{"s":24,"e":31,"c":"pl-s"},{"s":33,"e":48,"c":"pl-s"},{"s":52,"e":55,"c":"pl-c1"}],[{"s":4,"e":6,"c":"pl-k"},{"s":7,"e":15,"c":"pl-s1"},{"s":16,"e":18,"c":"pl-c1"},{"s":19,"e":23,"c":"pl-c1"},{"s":24,"e":26,"c":"pl-c1"},{"s":27,"e":35,"c":"pl-s1"},{"s":36,"e":38,"c":"pl-c1"},{"s":39,"e":41,"c":"pl-s"}],[{"s":8,"e":14,"c":"pl-k"},{"s":15,"e":22,"c":"pl-en"},{"s":24,"e":31,"c":"pl-s"},{"s":33,"e":51,"c":"pl-s"},{"s":55,"e":58,"c":"pl-c1"}],[{"s":4,"e":9,"c":"pl-s1"},{"s":10,"e":11,"c":"pl-c1"},{"s":12,"e":16,"c":"pl-v"},{"s":17,"e":23,"c":"pl-en"},{"s":25,"e":32,"c":"pl-s"},{"s":34,"e":39,"c":"pl-s1"}],[{"s":4,"e":6,"c":"pl-k"},{"s":7,"e":10,"c":"pl-c1"},{"s":11,"e":16,"c":"pl-s1"},{"s":17,"e":19,"c":"pl-c1"},{"s":20,"e":25,"c":"pl-s1"},{"s":26,"e":28,"c":"pl-c1"}],[{"s":8,"e":14,"c":"pl-k"},{"s":15,"e":22,"c":"pl-en"},{"s":24,"e":31,"c":"pl-s"},{"s":33,"e":63,"c":"pl-s"},{"s":67,"e":70,"c":"pl-c1"}],[{"s":4,"e":7,"c":"pl-k"},{"s":8,"e":12,"c":"pl-s1"},{"s":13,"e":15,"c":"pl-c1"},{"s":16,"e":21,"c":"pl-s1"}],[{"s":8,"e":10,"c":"pl-k"},{"s":11,"e":15,"c":"pl-s1"},{"s":16,"e":33,"c":"pl-en"},{"s":34,"e":42,"c":"pl-s1"}],[{"s":12,"e":16,"c":"pl-k"},{"s":17,"e":20,"c":"pl-s1"},{"s":21,"e":23,"c":"pl-s1"},{"s":24,"e":27,"c":"pl-s1"},{"s":28,"e":34,"c":"pl-k"},{"s":35,"e":39,"c":"pl-s1"}],[{"s":12,"e":22,"c":"pl-s1"},{"s":23,"e":24,"c":"pl-c1"},{"s":25,"e":29,"c":"pl-s1"},{"s":30,"e":44,"c":"pl-en"},{"s":45,"e":49,"c":"pl-s1"},{"s":50,"e":52,"c":"pl-s1"}],[{"s":12,"e":16,"c":"pl-s1"},{"s":17,"e":18,"c":"pl-c1"},{"s":19,"e":26,"c":"pl-en"},{"s":27,"e":31,"c":"pl-s1"},{"s":32,"e":39,"c":"pl-en"}],[{"s":12,"e":24,"c":"pl-s1"},{"s":25,"e":26,"c":"pl-c1"},{"s":27,"e":29,"c":"pl-s1"},{"s":30,"e":36,"c":"pl-en"},{"s":37,"e":51,"c":"pl-s"}],[{"s":12,"e":16,"c":"pl-s1"},{"s":17,"e":27,"c":"pl-en"},{"s":28,"e":40,"c":"pl-s1"},{"s":42,"e":52,"c":"pl-s1"}],[{"s":12,"e":18,"c":"pl-k"},{"s":19,"e":23,"c":"pl-s1"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":18,"c":"pl-en"},{"s":20,"e":27,"c":"pl-s"},{"s":29,"e":45,"c":"pl-s"},{"s":49,"e":52,"c":"pl-c1"}],[],[],[{"s":0,"e":40,"c":"pl-en"},{"s":1,"e":10,"c":"pl-s1"},{"s":11,"e":16,"c":"pl-en"},{"s":17,"e":39,"c":"pl-s"}],[{"s":0,"e":58,"c":"pl-en"},{"s":17,"e":24,"c":"pl-s1"},{"s":24,"e":25,"c":"pl-c1"},{"s":26,"e":34,"c":"pl-s"},{"s":37,"e":51,"c":"pl-s1"},{"s":51,"e":52,"c":"pl-c1"},{"s":52,"e":57,"c":"pl-c1"}],[{"s":0,"e":3,"c":"pl-k"},{"s":4,"e":10,"c":"pl-en"}],[{"s":4,"e":7,"c":"pl-s"}],[{"s":0,"e":24,"c":"pl-s"}],[{"s":0,"e":7,"c":"pl-s"}],[{"s":4,"e":8,"c":"pl-k"},{"s":9,"e":12,"c":"pl-s1"},{"s":13,"e":15,"c":"pl-s1"},{"s":16,"e":19,"c":"pl-s1"},{"s":20,"e":26,"c":"pl-k"},{"s":27,"e":31,"c":"pl-s1"}],[{"s":4,"e":6,"c":"pl-k"},{"s":7,"e":11,"c":"pl-s1"},{"s":12,"e":27,"c":"pl-en"},{"s":28,"e":35,"c":"pl-s1"}],[{"s":8,"e":14,"c":"pl-k"},{"s":15,"e":22,"c":"pl-en"},{"s":28,"e":31,"c":"pl-c1"}],[{"s":4,"e":9,"c":"pl-en"},{"s":10,"e":13,"c":"pl-c1"}]],"colorizedLines":null,"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/Innocentsax/alx-backend-user-data/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":null},"displayName":"session_auth.py","displayUrl":"https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py?raw=true","headerInfo":{"blobSize":"1.34 KB","deleteTooltip":"You must be signed in to make or propose changes","editTooltip":"You must be signed in to make or propose changes","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"9c901a6","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x02-Session_authentication%2Fapi%2Fv1%2Fviews%2Fsession_auth.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"43","truncatedSloc":"39"},"mode":"executable file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/session_auth.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/Innocentsax/alx-backend-user-data/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/Innocentsax/alx-backend-user-data/raw/refs/heads/main/0x02-Session_authentication/api/v1/views/session_auth.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"session_auth","kind":"function","ident_start":248,"ident_end":260,"extent_start":244,"extent_end":1100,"fully_qualified_name":"session_auth","ident_utf16":{"start":{"line_number":10,"utf16_col":4},"end":{"line_number":10,"utf16_col":16}},"extent_utf16":{"start":{"line_number":10,"utf16_col":0},"end":{"line_number":30,"utf16_col":52}}},{"name":"logout","kind":"function","ident_start":1207,"ident_end":1213,"extent_start":1203,"extent_end":1374,"fully_qualified_name":"logout","ident_utf16":{"start":{"line_number":35,"utf16_col":4},"end":{"line_number":35,"utf16_col":10}},"extent_utf16":{"start":{"line_number":35,"utf16_col":0},"end":{"line_number":42,"utf16_col":14}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/Innocentsax/alx-backend-user-data/branches":{"post":"3JKLh4Bt8iDEkeCfic_-7n0h5i5SCKMPO1NmsQ6MJiJH2tU_Sq_IgnYnVXSNDZGCVmF9WxEegjaWI5U-X54bDA"},"/repos/preferences":{"post":"52uUbyOyMU5Hiq19E_qHDvO1oA3uV9BpvFkYsHRypeBv1_Ryh_3_JiVWSiS2CIxVxTkxbUM-SWV0JH-VxIJAvA"}}},"title":"alx-backend-user-data/0x02-Session_authentication/api/v1/views/session_auth.py at main · Innocentsax/alx-backend-user-data","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative"><span class="pl-en">@<span class="pl-s1">app_views</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/auth_session/login&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;POST&#039;</span>], <span class="pl-s1">strict_slashes</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">session_auth</span>():</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;_summary_</span></div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative">    <span class="pl-s1">email</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>.<span class="pl-en">get</span>(<span class="pl-s">&#039;email&#039;</span>)</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative">    <span class="pl-s1">password</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>.<span class="pl-en">get</span>(<span class="pl-s">&#039;password&#039;</span>)</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">email</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span> <span class="pl-c1">or</span> <span class="pl-s1">email</span> <span class="pl-c1">==</span> <span class="pl-s">&#039;&#039;</span>:</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">        <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({<span class="pl-s">&quot;error&quot;</span>: <span class="pl-s">&quot;email missing&quot;</span>}), <span class="pl-c1">400</span></div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">password</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span> <span class="pl-c1">or</span> <span class="pl-s1">password</span> <span class="pl-c1">==</span> <span class="pl-s">&#039;&#039;</span>:</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative">        <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({<span class="pl-s">&quot;error&quot;</span>: <span class="pl-s">&quot;password missing&quot;</span>}), <span class="pl-c1">400</span></div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative">    <span class="pl-s1">users</span> <span class="pl-c1">=</span> <span class="pl-v">User</span>.<span class="pl-en">search</span>({<span class="pl-s">&quot;email&quot;</span>: <span class="pl-s1">email</span>})</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative">    <span class="pl-k">if</span> <span class="pl-c1">not</span> <span class="pl-s1">users</span> <span class="pl-c1">or</span> <span class="pl-s1">users</span> <span class="pl-c1">==</span> []:</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative">        <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({<span class="pl-s">&quot;error&quot;</span>: <span class="pl-s">&quot;no user found for this email&quot;</span>}), <span class="pl-c1">404</span></div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative">    <span class="pl-k">for</span> <span class="pl-s1">user</span> <span class="pl-c1">in</span> <span class="pl-s1">users</span>:</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">user</span>.<span class="pl-en">is_valid_password</span>(<span class="pl-s1">password</span>):</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative">            <span class="pl-k">from</span> <span class="pl-s1">api</span>.<span class="pl-s1">v1</span>.<span class="pl-s1">app</span> <span class="pl-k">import</span> <span class="pl-s1">auth</span></div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative">            <span class="pl-s1">session_id</span> <span class="pl-c1">=</span> <span class="pl-s1">auth</span>.<span class="pl-en">create_session</span>(<span class="pl-s1">user</span>.<span class="pl-s1">id</span>)</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">            <span class="pl-s1">resp</span> <span class="pl-c1">=</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">user</span>.<span class="pl-en">to_json</span>())</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative">            <span class="pl-s1">session_name</span> <span class="pl-c1">=</span> <span class="pl-s1">os</span>.<span class="pl-en">getenv</span>(<span class="pl-s">&#039;SESSION_NAME&#039;</span>)</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative">            <span class="pl-s1">resp</span>.<span class="pl-en">set_cookie</span>(<span class="pl-s1">session_name</span>, <span class="pl-s1">session_id</span>)</div></div></div><div class="child-of-line-10  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative">            <span class="pl-k">return</span> <span class="pl-s1">resp</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({<span class="pl-s">&quot;error&quot;</span>: <span class="pl-s">&quot;wrong password&quot;</span>}), <span class="pl-c1">401</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative"><span class="pl-en">@<span class="pl-s1">app_views</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/auth_session/logout&#039;</span>,</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative"><span class="pl-en">                 <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;DELETE&#039;</span>], <span class="pl-s1">strict_slashes</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">logout</span>():</div></div></div><div class="child-of-line-35  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-35  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative"><span class="pl-s">    for logging out user</span></div></div></div><div class="child-of-line-35  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-35  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative">    <span class="pl-k">from</span> <span class="pl-s1">api</span>.<span class="pl-s1">v1</span>.<span class="pl-s1">app</span> <span class="pl-k">import</span> <span class="pl-s1">auth</span></div></div></div><div class="child-of-line-35  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">auth</span>.<span class="pl-en">destroy_session</span>(<span class="pl-s1">request</span>):</div></div></div><div class="child-of-line-35  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative">        <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({}), <span class="pl-c1">200</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative">    <span class="pl-en">abort</span>(<span class="pl-c1">404</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
