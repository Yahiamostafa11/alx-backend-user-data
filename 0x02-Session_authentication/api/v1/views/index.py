...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>alx-backend-user-data/0x02-Session_authentication/api/v1/views/index.py at main · Innocentsax/alx-backend-user-data · GitHub</title>
  ...
  <meta name="request-id" content="CCC5:0EBD:F3192:F9EB3:66EC8FDA" data-pjax-transient="true"/><meta name="html-safe-nonce" content="f373bdde318f13278c81380cf3c4f153946cb580bb72c240e853b6b84256abd2" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJDQ0M1OjBFQkQ6RjMxOTI6RjlFQjM6NjZFQzhGREEiLCJ2aXNpdG9yX2lkIjoiNTA2OTQyNTc1MDMxODAyNjcxNCIsInJlZ2lvbl9lZGdlIjoiZnJhIiwicmVnaW9uX3JlbmRlciI6ImZyYSJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="14b196f8a31641d291443e9c015d6eaad9c1b9f3987472287324723e49dd4922" data-pjax-transient="true"/>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - alx-backend-user-data/0x02-Session_authentication/api/v1/views/index.py at main · Innocentsax/alx-backend-user-data">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="alx-backend-user-data/0x02-Session_authentication/api/v1/views/index.py at main · Innocentsax/alx-backend-user-data" /><meta name="twitter:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  <meta property="og:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta property="og:image:alt" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="alx-backend-user-data/0x02-Session_authentication/api/v1/views/index.py at main · Innocentsax/alx-backend-user-data" /><meta property="og:url" content="https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py" /><meta property="og:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x02-Session_authentication%2Fapi%2Fv1%2Fviews%2Findex.py"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="9c5c13fa7d1c63c5733b651a2cd648c8669bd3cd55c21bca3f76a3655e4ea791"
...
<qbsearch-input class="search-input" data-scope="repo:Innocentsax/alx-backend-user-data" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="JGtFZfwd8wlnvzj8pxaa4vp1Orw4GK98ahAGfWGXMb_N2g7U7XR2DIh1eloPklvnuXMHEuW_tKVbrzmrbCuS6Q" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Innocentsax/alx-backend-user-data" data-current-org="" data-current-owner="Innocentsax" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-fb3fe6bb-df31-40ed-a842-367f9ed75b02" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-fb3fe6bb-df31-40ed-a842-367f9ed75b02" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="DtjcnTylSDCfvfigzUcKLemqQbCLDvfxhLnxY1tSkr8+iP/pMJANyR2osV/OW0RlHqvchSxhfnRaJCeVS0+bdQ==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="AbC4eZ7g7nqgJmlfcdzI+L4f03NgKQQU6pJwZq/UI/lC1GraOlqQz19UOKq1HChuPRIRM+LnCIhtbOZY2CyY3w==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="C9wD2+ngzawrGPzkj2twjaQKJtHb/VryrWhG/nDB8fClcgrvtAwlPgSx+yeCcnnoE3h6mK90CPLgP4WfeuCM7w==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-a58c5393-b8d6-405f-99b2-4ae0c0c69414" aria-labelledby="tooltip-6d8155f8-5f27-49b6-8c47-3dc7b08e58e5" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-6d8155f8-5f27-49b6-8c47-3dc7b08e58e5" for="icon-button-a58c5393-b8d6-405f-99b2-4ae0c0c69414" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="3f1b11bc97212574da48ce46b82e160dfad2f4a73cd66c4755da367a6105a62d" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-0e92a556-2c3d-4d32-81b9-7fa2402d96ee" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

  </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="6bae23de2799c7b92270731ef8ed23a76f5ca5fb86ff3c854a042056dce64773" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="cfa92d0fe7501feadd670fde6de79bea013e4e541629f4a2386dda4c88c3626d" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-button" popovertarget="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-overlay" aria-controls="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-list" aria-haspopup="true" aria-labelledby="tooltip-fd894459-48de-4e24-be59-d85fb19ecb9b" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-fd894459-48de-4e24-be59-d85fb19ecb9b" for="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-overlay" anchor="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-button" id="action-menu-ec861d93-0684-49a7-bd6f-6041bffe6a4e-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-fd623693-e4d1-42e1-8fe4-80cc78ca2b9e" href="/Innocentsax/alx-backend-user-data" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-0606977b-6b9d-4459-b5fe-bafd9bcc9593" href="/Innocentsax/alx-backend-user-data/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-baa0c114-a939-4e19-afb7-2f51980cd2f3" href="/Innocentsax/alx-backend-user-data/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-5314e550-0bee-447c-9154-04607da4ef08" href="/Innocentsax/alx-backend-user-data/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-f8bd70c3-95c5-4ba2-a50e-cfc8db1d9613" href="/Innocentsax/alx-backend-user-data/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-930ab553-0bd6-40e3-ae7b-f9ed41be3106" href="/Innocentsax/alx-backend-user-data/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-423a8bd6-ca90-4667-8d7c-2be8f9ece168" href="/Innocentsax/alx-backend-user-data/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/Innocentsax/alx-backend-user-data/blob/main/0x02-Session_authentication/api/v1/views/index.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"0x02-Session_authentication/api/v1/views":{"items":[{"name":"__pycache__","path":"0x02-Session_authentication/api/v1/views/__pycache__","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/api/v1/views/.DS_Store","contentType":"file"},{"name":"__init__.py","path":"0x02-Session_authentication/api/v1/views/__init__.py","contentType":"file"},{"name":"index.py","path":"0x02-Session_authentication/api/v1/views/index.py","contentType":"file"},{"name":"session_auth.py","path":"0x02-Session_authentication/api/v1/views/session_auth.py","contentType":"file"},{"name":"users.py","path":"0x02-Session_authentication/api/v1/views/users.py","contentType":"file"}],"totalCount":6},"0x02-Session_authentication/api/v1":{"items":[{"name":"__pycache__","path":"0x02-Session_authentication/api/v1/__pycache__","contentType":"directory"},{"name":"auth","path":"0x02-Session_authentication/api/v1/auth","contentType":"directory"},{"name":"views","path":"0x02-Session_authentication/api/v1/views","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/api/v1/.DS_Store","contentType":"file"},{"name":"__init__.py","path":"0x02-Session_authentication/api/v1/__init__.py","contentType":"file"},{"name":"app.py","path":"0x02-Session_authentication/api/v1/app.py","contentType":"file"}],"totalCount":6},"0x02-Session_authentication/api":{"items":[{"name":"__pycache__","path":"0x02-Session_authentication/api/__pycache__","contentType":"directory"},{"name":"v1","path":"0x02-Session_authentication/api/v1","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/api/.DS_Store","contentType":"file"},{"name":"__init__.py","path":"0x02-Session_authentication/api/__init__.py","contentType":"file"}],"totalCount":4},"0x02-Session_authentication":{"items":[{"name":"api","path":"0x02-Session_authentication/api","contentType":"directory"},{"name":"models","path":"0x02-Session_authentication/models","contentType":"directory"},{"name":".DS_Store","path":"0x02-Session_authentication/.DS_Store","contentType":"file"},{"name":"README.md","path":"0x02-Session_authentication/README.md","contentType":"file"},{"name":"requirements.txt","path":"0x02-Session_authentication/requirements.txt","contentType":"file"}],"totalCount":5},"":{"items":[{"name":"0x00-personal_data","path":"0x00-personal_data","contentType":"directory"},{"name":"0x01-Basic_authentication","path":"0x01-Basic_authentication","contentType":"directory"},{"name":"0x02-Session_authentication","path":"0x02-Session_authentication","contentType":"directory"},{"name":"0x03-user_authentication_service","path":"0x03-user_authentication_service","contentType":"directory"},{"name":".DS_Store","path":".DS_Store","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Screenshot 2023-11-01 at 12.58.39 PM.png","path":"Screenshot 2023-11-01 at 12.58.39 PM.png","contentType":"file"}],"totalCount":8}},"fileTreeProcessingTime":19.54772,"foldersToFetch":[],"repo":{"id":712869884,"defaultBranch":"main","name":"alx-backend-user-data","ownerLogin":"Innocentsax","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-11-01T11:22:09.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/117287767?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1698839736.0","canEdit":false,"refType":"branch","currentOid":"465ee6ac460d1eb969bb744c6fa1c3dac0fc78d8"},"path":"0x02-Session_authentication/api/v1/views/index.py","currentUser":null,"blob":{"rawLines":["#!/usr/bin/env python3","\"\"\" Module of Index views","\"\"\"","from flask import jsonify, abort","from api.v1.views import app_views","","","# unauthorized access","@app_views.route('/unauthorized', methods=['GET'], strict_slashes=False)","def unauthorized() -\u003e str:","    \"\"\"_summary_","","    Returns:","        str: _description_","    \"\"\"","    abort(401, description='Unauthorized')","","# forbidden","@app_views.route('/forbidden', methods=['GET'], strict_slashes=False)","def forbidden() -\u003e str:","    \"\"\"_summary_","","    Returns:","        str: _description_","    \"\"\"","    abort(403, description='Forbidden')","","","@app_views.route('/status', methods=['GET'], strict_slashes=False)","def status() -\u003e str:","    \"\"\" GET /api/v1/status","    Return:","      - the status of the API","    \"\"\"","    return jsonify({\"status\": \"OK\"})","","","@app_views.route('/stats/', strict_slashes=False)","def stats() -\u003e str:","    \"\"\" GET /api/v1/stats","    Return:","      - the number of each objects","    \"\"\"","    from models.user import User","    stats = {}","    stats['users'] = User.count()","    return jsonify(stats)"],"stylingDirectives":[[{"s":0,"e":22,"c":"pl-c"}],[{"s":0,"e":25,"c":"pl-s"}],[{"s":0,"e":3,"c":"pl-s"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":10,"c":"pl-s1"},{"s":11,"e":17,"c":"pl-k"},{"s":18,"e":25,"c":"pl-s1"},{"s":27,"e":32,"c":"pl-s1"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":8,"c":"pl-s1"},{"s":9,"e":11,"c":"pl-s1"},{"s":12,"e":17,"c":"pl-s1"},{"s":18,"e":24,"c":"pl-k"},{"s":25,"e":34,"c":"pl-s1"}],[],[],[{"s":0,"e":21,"c":"pl-c"}],[{"s":0,"e":72,"c":"pl-en"},{"s":1,"e":10,"c":"pl-s1"},{"s":11,"e":16,"c":"pl-en"},{"s":17,"e":32,"c":"pl-s"},{"s":34,"e":41,"c":"pl-s1"},{"s":41,"e":42,"c":"pl-c1"},{"s":43,"e":48,"c":"pl-s"},{"s":51,"e":65,"c":"pl-s1"},{"s":65,"e":66,"c":"pl-c1"},{"s":66,"e":71,"c":"pl-c1"}],[{"s":0,"e":3,"c":"pl-k"},{"s":4,"e":16,"c":"pl-en"},{"s":19,"e":21,"c":"pl-c1"},{"s":22,"e":25,"c":"pl-s1"}],[{"s":4,"e":16,"c":"pl-s"}],[{"s":0,"e":0,"c":"pl-s"}],[{"s":0,"e":12,"c":"pl-s"}],[{"s":0,"e":26,"c":"pl-s"}],[{"s":0,"e":7,"c":"pl-s"}],[{"s":4,"e":9,"c":"pl-en"},{"s":10,"e":13,"c":"pl-c1"},{"s":15,"e":26,"c":"pl-s1"},{"s":26,"e":27,"c":"pl-c1"},{"s":27,"e":41,"c":"pl-s"}],[],[{"s":0,"e":11,"c":"pl-c"}],[{"s":0,"e":69,"c":"pl-en"},{"s":1,"e":10,"c":"pl-s1"},{"s":11,"e":16,"c":"pl-en"},{"s":17,"e":29,"c":"pl-s"},{"s":31,"e":38,"c":"pl-s1"},{"s":38,"e":39,"c":"pl-c1"},{"s":40,"e":45,"c":"pl-s"},{"s":48,"e":62,"c":"pl-s1"},{"s":62,"e":63,"c":"pl-c1"},{"s":63,"e":68,"c":"pl-c1"}],[{"s":0,"e":3,"c":"pl-k"},{"s":4,"e":13,"c":"pl-en"},{"s":16,"e":18,"c":"pl-c1"},{"s":19,"e":22,"c":"pl-s1"}],[{"s":4,"e":16,"c":"pl-s"}],[{"s":0,"e":0,"c":"pl-s"}],[{"s":0,"e":12,"c":"pl-s"}],[{"s":0,"e":26,"c":"pl-s"}],[{"s":0,"e":7,"c":"pl-s"}],[{"s":4,"e
}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/Innocentsax/alx-backend-user-data/branches":{"post":"-60ruQU6sBnlZ6V0lMgI-_Mb17DW5NJIpbRKf60OU14Ln3ak4o0hGBT13jq8lG4_A08FlAGLzA7yYWLAOLhxUA"},"/repos/preferences":{"post":"iMaEJ6cS9WselA_z7PQivQDnlKksplQSyfxiEMpVvjLR12Ii-t7na0PfF0rJvXbpwl6XYX4rOK3aXCLQr2fCkQ"}}},"title":"alx-backend-user-data/0x02-Session_authentication/api/v1/views/index.py at main · Innocentsax/alx-backend-user-data","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC8" class="react-file-line html-div" data-testid="code-cell" data-line-number="8" style="position:relative"><span class="pl-c"># unauthorized access</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC9" class="react-file-line html-div" data-testid="code-cell" data-line-number="9" style="position:relative"><span class="pl-en">@<span class="pl-s1">app_views</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/unauthorized&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;GET&#039;</span>], <span class="pl-s1">strict_slashes</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">unauthorized</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-9  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;_summary_</span></div></div></div><div class="child-of-line-9  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative">
</div></div></div><div class="child-of-line-9  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative"><span class="pl-s">    Returns:</span></div></div></div><div class="child-of-line-9  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative"><span class="pl-s">        str: _description_</span></div></div></div><div class="child-of-line-9  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative">    <span class="pl-en">abort</span>(<span class="pl-c1">401</span>, <span class="pl-s1">description</span><span class="pl-c1">=</span><span class="pl-s">&#039;Unauthorized&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative"><span class="pl-c"># forbidden</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative"><span class="pl-en">@<span class="pl-s1">app_views</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/forbidden&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;GET&#039;</span>], <span class="pl-s1">strict_slashes</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">forbidden</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-19  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;_summary_</span></div></div></div><div class="child-of-line-19  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative">
</div></div></div><div class="child-of-line-19  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative"><span class="pl-s">    Returns:</span></div></div></div><div class="child-of-line-19  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative"><span class="pl-s">        str: _description_</span></div></div></div><div class="child-of-line-19  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative">    <span class="pl-en">abort</span>(<span class="pl-c1">403</span>, <span class="pl-s1">description</span><span class="pl-c1">=</span><span class="pl-s">&#039;Forbidden&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative"><span class="pl-en">@<span class="pl-s1">app_views</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/status&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;GET&#039;</span>], <span class="pl-s1">strict_slashes</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">status</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; GET /api/v1/status</span></div></div></div><div class="child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative"><span class="pl-s">    Return:</span></div></div></div><div class="child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative"><span class="pl-s">      - the status of the API</span></div></div></div><div class="child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({<span class="pl-s">&quot;status&quot;</span>: <span class="pl-s">&quot;OK&quot;</span>})</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative"><span class="pl-en">@<span class="pl-s1">app_views</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/stats/&#039;</span>, <span class="pl-s1">strict_slashes</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">stats</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; GET /api/v1/stats</span></div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative"><span class="pl-s">    Return:</span></div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative"><span class="pl-s">      - the number of each objects</span></div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative">    <span class="pl-k">from</span> <span class="pl-s1">models</span>.<span class="pl-s1">user</span> <span class="pl-k">import</span> <span class="pl-v">User</span></div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative">    <span class="pl-s1">stats</span> <span class="pl-c1">=</span> {}</div></div></div><div class="child-of-line-38  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative">    <span class="pl-s1">stats</span>[<span class="pl-s">&#039;users&#039;</span>] <span class="pl-c1">=</span> <span class="pl-v">User</span>.<span class="pl-en">count</span>()</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">stats</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
