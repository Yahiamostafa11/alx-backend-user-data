...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>alx-backend-user-data/0x03-user_authentication_service/app.py at main · Innocentsax/alx-backend-user-data · GitHub</title>
  ...
  <meta name="request-id" content="C1E7:7CF6F:595F70:5AE753:66F43F43" data-pjax-transient="true"/><meta name="html-safe-nonce" content="ce91c8bccdf41ff4a88d985e0b4cc0d42bc471cd82d454b6039eda09783ed694" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJDMUU3OjdDRjZGOjU5NUY3MDo1QUU3NTM6NjZGNDNGNDMiLCJ2aXNpdG9yX2lkIjoiNjIyODMxNzY1MDMwODg0MTI4MyIsInJlZ2lvbl9lZGdlIjoiZnJhIiwicmVnaW9uX3JlbmRlciI6ImZyYSJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="2f12fbfbbf74d53823104921e77fd7e444acd37a948dc2b6211623267573ec8d" data-pjax-transient="true"/>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - alx-backend-user-data/0x03-user_authentication_service/app.py at main · Innocentsax/alx-backend-user-data">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py" />

      <meta name="twitter:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="alx-backend-user-data/0x03-user_authentication_service/app.py at main · Innocentsax/alx-backend-user-data" /><meta name="twitter:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  <meta property="og:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta property="og:image:alt" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="alx-backend-user-data/0x03-user_authentication_service/app.py at main · Innocentsax/alx-backend-user-data" /><meta property="og:url" content="https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py" /><meta property="og:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x03-user_authentication_service%2Fapp.py"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="0ac50446bd31f4fbc4aad34eac0dde746cd526f900145c5491cd837af95617be"
...
<qbsearch-input class="search-input" data-scope="repo:Innocentsax/alx-backend-user-data" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="EiGyYKu92ypBZ16yKHOb_uUjildsUeEjWrBig79kbmMXGSh_-xNYa8-p2b8dDofE4xQ1MiCHBnX7aei1yYrSrA" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Innocentsax/alx-backend-user-data" data-current-org="" data-current-owner="Innocentsax" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-1f0cc3ab-4a5d-48d1-986e-3f05bb08f8ca" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-1f0cc3ab-4a5d-48d1-986e-3f05bb08f8ca" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="d8w4PF8vnLZe83egl5DGCdQdYyPons1xhCeQqmW7+pDM5Gv5SLVkw2uIMjEXb4dC+LdZk+tN1gTJ94qJX1lgfQ==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="HW0P1OBlKyqp6fbuA+6uc2hYG4lNIO+02ZMGRi+x87nXeuH7qCLoCodgOzMhf4zyxgS2JlEXIvTpL9OL9RXSBg==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="RZoGq/rVk8/B3mynpFuBZ1hMzdKkX2oInuvi35KTe0xDrPgqksZwBvyEnQCUApehudW2ut2uchIvjNM+PCARPg==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-0e67f171-63c9-49a2-9eca-fed0a72c6e75" aria-labelledby="tooltip-c573bf11-bbfd-4a55-a9c8-2c17204a6c10" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-c573bf11-bbfd-4a55-a9c8-2c17204a6c10" for="icon-button-0e67f171-63c9-49a2-9eca-fed0a72c6e75" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="800f5be79c5aab033576a663c2b457d2ac8de5998fe29e6fe85bf94b728bee3a" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-544d3829-dad2-41fb-a1ae-d2c31cfac39a" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

  </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="d59e0a752cd2a7db33f5f84326c96777e69c9ce2962d94812fdf6521cf6cc137" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="0cba155ff4b1420ccf97ec7387e2956636d22c5f43af665882909c0a661ee04f" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-button" popovertarget="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-overlay" aria-controls="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-list" aria-haspopup="true" aria-labelledby="tooltip-b6636e01-ae4a-4cb0-88dd-102dff23a88d" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-b6636e01-ae4a-4cb0-88dd-102dff23a88d" for="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-overlay" anchor="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-button" id="action-menu-201237c6-bfcc-49ae-b191-de9fbccd4afe-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-db029424-a298-456b-9584-67de80541baf" href="/Innocentsax/alx-backend-user-data" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-57f60b35-d4b5-4be2-a882-a3bef104b6f6" href="/Innocentsax/alx-backend-user-data/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-47fc51a2-3a20-4f58-b208-6e790902b70a" href="/Innocentsax/alx-backend-user-data/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-61c84fc5-e601-482d-a64a-84749f42e597" href="/Innocentsax/alx-backend-user-data/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-96b32851-c992-4bb6-af5f-e5c2cb592a91" href="/Innocentsax/alx-backend-user-data/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-fd5fc364-e990-4b4b-8d17-9a768203276d" href="/Innocentsax/alx-backend-user-data/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-86840289-271d-477b-a96a-ea70cd745edf" href="/Innocentsax/alx-backend-user-data/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/app.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"0x03-user_authentication_service":{"items":[{"name":"README.md","path":"0x03-user_authentication_service/README.md","contentType":"file"},{"name":"app.py","path":"0x03-user_authentication_service/app.py","contentType":"file"},{"name":"auth.py","path":"0x03-user_authentication_service/auth.py","contentType":"file"},{"name":"db.py","path":"0x03-user_authentication_service/db.py","contentType":"file"},{"name":"main.py","path":"0x03-user_authentication_service/main.py","contentType":"file"},{"name":"user.py","path":"0x03-user_authentication_service/user.py","contentType":"file"}],"totalCount":6},"":{"items":[{"name":"0x00-personal_data","path":"0x00-personal_data","contentType":"directory"},{"name":"0x01-Basic_authentication","path":"0x01-Basic_authentication","contentType":"directory"},{"name":"0x02-Session_authentication","path":"0x02-Session_authentication","contentType":"directory"},{"name":"0x03-user_authentication_service","path":"0x03-user_authentication_service","contentType":"directory"},{"name":".DS_Store","path":".DS_Store","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Screenshot 2023-11-01 at 12.58.39 PM.png","path":"Screenshot 2023-11-01 at 12.58.39 PM.png","contentType":"file"}],"totalCount":8}},"fileTreeProcessingTime":12.813766000000001,"foldersToFetch":[],"repo":{"id":712869884,"defaultBranch":"main","name":"alx-backend-user-data","ownerLogin":"Innocentsax","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-11-01T11:22:09.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/117287767?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1698839736.0","canEdit":false,"refType":"branch","currentOid":"465ee6ac460d1eb969bb744c6fa1c3dac0fc78d8"},"path":"0x03-user_authentication_service/app.py","currentUser":null,"blob":{"rawLines":["#!/usr/bin/env python3","\"\"\"API Routes for Authentication Service\"\"\"","from auth import Auth","from flask import (Flask,","                   jsonify,","                   request,","                   abort,","                   redirect)","","app = Flask(__name__)","AUTH = Auth()","","","@app.route('/', methods=['GET'])","def hello_world() -\u003e str:","    \"\"\" Base route for authentication service API \"\"\"","    msg = {\"message\": \"Bienvenue\"}","    return jsonify(msg)","","","@app.route('/users', methods=['POST'])","def register_user() -\u003e str:","    \"\"\"Registers a new user if it does not exist before\"\"\"","    try:","        email = request.form['email']","        password = request.form['password']","    except KeyError:","        abort(400)","","    try:","        user = AUTH.register_user(email, password)","    except ValueError:","        return jsonify({\"message\": \"email already registered\"}), 400","","    msg = {\"email\": email, \"message\": \"user created\"}","    return jsonify(msg)","","","@app.route('/sessions', methods=['POST'])","def log_in() -\u003e str:","    \"\"\" Logs in a user and returns session ID \"\"\"","    try:","        email = request.form['email']","        password = request.form['password']","    except KeyError:","        abort(400)","","    if not AUTH.valid_login(email, password):","        abort(401)","","    session_id = AUTH.create_session(email)","","    msg = {\"email\": email, \"message\": \"logged in\"}","    response = jsonify(msg)","","    response.set_cookie(\"session_id\", session_id)","","    return response","","","@app.route('/sessions', methods=['DELETE'])","def log_out() -\u003e str:","    \"\"\"Find the user with the requested session ID.","    If the user exists destroy the session and redirect the user to GET /.","    If the user does not exist, respond with a 403 HTTP status.","    \"\"\"","    session_id = request.cookies.get(\"session_id\", None)","","    if session_id is None:","        abort(403)","","    user = AUTH.get_user_from_session_id(session_id)","","    if user is None:","        abort(403)","","    AUTH.destroy_session(user.id)","","    return redirect('/')","","","@app.route('/profile', methods=['GET'])","def profile() -\u003e str:","    \"\"\" If the user exist, respond with a 200 HTTP status and a JSON Payload","    Otherwise respond with a 403 HTTP status.","    \"\"\"","    session_id = request.cookies.get(\"session_id\", None)","","    if session_id is None:","        abort(403)","","    user = AUTH.get_user_from_session_id(session_id)","","    if user is None:","        abort(403)","","    msg = {\"email\": user.email}","","    return jsonify(msg), 200","","","@app.route('/reset_password', methods=['POST'])","def reset_password() -\u003e str:","    \"\"\"If the email is not registered, respond with a 403 status code.","    Otherwise, generate a token and respond with a","    200 HTTP status and JSON Payload","    \"\"\"","    try:","        email = request.form['email']","    except KeyError:","        abort(403)","","    try:","        reset_token = AUTH.get_reset_password_token(email)","    except ValueError:","        abort(403)","","    msg = {\"email\": email, \"reset_token\": reset_token}","","    return jsonify(msg), 200","","","@app.route('/reset_password', methods=['PUT'])","def update_password() -\u003e str:","    \"\"\" PUT /reset_password","    Updates password with reset token","    Return:","        - 400 if bad request","        - 403 if not valid reset token","        - 200 and JSON Payload if valid","    \"\"\"","    try:","        email = request.form['email']","        reset_token = request.form['reset_token']","        new_password = request.form['new_password']","    except KeyError:","        abort(400)","","    try:","        AUTH.update_password(reset_token, new_password)","    except ValueError:","        abort(403)","","    msg = {\"email\": email, \"message\": \"Password updated\"}","    return jsonify(msg), 200","","","if __name__ == \"__main__\":","    app.run(host=\"0.0.0.0\", port=\"5000\")"],"stylingDirectives":[[{"s":0,"e":22,"c":"pl-c"}],[{"s":0,"e":43,"c":"pl-s"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":9,"c":"pl-s1"},{"s":10,"e":16,"c":"pl-k"},{"s":17,"e":21,"c":"pl-v"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":10,"c":"pl-s1"},{"s":11,"e":17,"c":"pl-k"},{"s":19,"e":24,"c":"pl-v"}],[{"s":19,"e":26,"c":"pl-s1"}],[{"s":19,"e":26,"c":"pl-s1"}],[{"s":19,"e":24,"c":"pl-s1"}],[{"s":19,"e":27,"c":"pl-s1"}],[],[{"s":0,"e":3,"c":"pl-s1"},{"s":4,"e":5,"c":"pl-c1"},{"s":6,"e":11,"c":"pl-v"},{"s":12,"e":20,"c":"pl-s1"}],[{"s":0,"e":4,"c":"pl-v"},{"s":5,"e":6,"c":"pl-c1"},{"s":7,"e":11,"c":"pl-v"}],[],[],[{"s":0,"e":32,"c":"pl-en"},{"s":1,"e":4,"c":"pl-s1"},{"s":5,"e":10,"c":"pl-en"},{"s":11,"e
releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/Innocentsax/alx-backend-user-data/raw/refs/heads/main/0x03-user_authentication_service/app.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"app","kind":"constant","ident_start":227,"ident_end":230,"extent_start":227,"extent_end":248,"fully_qualified_name":"app","ident_utf16":{"start":{"line_number":9,"utf16_col":0},"end":{"line_number":9,"utf16_col":3}},"extent_utf16":{"start":{"line_number":9,"utf16_col":0},"end":{"line_number":9,"utf16_col":21}}},{"name":"AUTH","kind":"constant","ident_start":249,"ident_end":253,"extent_start":249,"extent_end":262,"fully_qualified_name":"AUTH","ident_utf16":{"start":{"line_number":10,"utf16_col":0},"end":{"line_number":10,"utf16_col":4}},"extent_utf16":{"start":{"line_number":10,"utf16_col":0},"end":{"line_number":10,"utf16_col":13}}},{"name":"hello_world","kind":"function","ident_start":302,"ident_end":313,"extent_start":298,"extent_end":436,"fully_qualified_name":"hello_world","ident_utf16":{"start":{"line_number":14,"utf16_col":4},"end":{"line_number":14,"utf16_col":15}},"extent_utf16":{"start":{"line_number":14,"utf16_col":0},"end":{"line_number":17,"utf16_col":23}}},{"name":"register_user","kind":"function","ident_start":482,"ident_end":495,"extent_start":478,"extent_end":927,"fully_qualified_name":"register_user","ident_utf16":{"start":{"line_number":21,"utf16_col":4},"end":{"line_number":21,"utf16_col":17}},"extent_utf16":{"start":{"line_number":21,"utf16_col":0},"end":{"line_number":35,"utf16_col":23}}},{"name":"log_in","kind":"function","ident_start":976,"ident_end":982,"extent_start":972,"extent_end":1436,"fully_qualified_name":"log_in","ident_utf16":{"start":{"line_number":39,"utf16_col":4},"end":{"line_number":39,"utf16_col":10}},"extent_utf16":{"start":{"line_number":39,"utf16_col":0},"end":{"line_number":57,"utf16_col":19}}},{"name":"log_out","kind":"function","ident_start":1487,"ident_end":1494,"extent_start":1483,"extent_end":1963,"fully_qualified_name":"log_out","ident_utf16":{"start":{"line_number":61,"utf16_col":4},"end":{"line_number":61,"utf16_col":11}},"extent_utf16":{"start":{"line_number":61,"utf16_col":0},"end":{"line_number":78,"utf16_col":24}}},{"name":"profile","kind":"function","ident_start":2010,"ident_end":2017,"extent_start":2006,"extent_end":2420,"fully_qualified_name":"profile","ident_utf16":{"start":{"line_number":82,"utf16_col":4},"end":{"line_number":82,"utf16_col":11}},"extent_utf16":{"start":{"line_number":82,"utf16_col":0},"end":{"line_number":98,"utf16_col":28}}},{"name":"reset_password","kind":"function","ident_start":2475,"ident_end":2489,"extent_start":2471,"extent_end":2950,"fully_qualified_name":"reset_password","ident_utf16":{"start":{"line_number":102,"utf16_col":4},"end":{"line_number":102,"utf16_col":18}},"extent_utf16":{"start":{"line_number":102,"utf16_col":0},"end":{"line_number":119,"utf16_col":28}}},{"name":"update_password","kind":"function","ident_start":3004,"ident_end":3019,"extent_start":3000,"extent_end":3608,"fully_qualified_name":"update_password","ident_utf16":{"start":{"line_number":123,"utf16_col":4},"end":{"line_number":123,"utf16_col":19}},"extent_utf16":{"start":{"line_number":123,"utf16_col":0},"end":{"line_number":144,"utf16_col":28}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/Innocentsax/alx-backend-user-data/branches":{"post":"P9DaextXTPyum0c2osiEcqUqdupvFvdjkdW2I30qS4zW1QMXChbC45TMxElXt-NOxmKz3eoTxXMxMKrenf2XtQ"},"/repos/preferences":{"post":"KsXJuYV7053O-xirl6cg10Xl6-oqtY6JWDdb0zAD7Hr-kXWXOxUTiM5_39DgfTqyhthCN4UYjdVzW7GkpfuwOQ"}}},"title":"alx-backend-user-data/0x03-user_authentication_service/app.py at main · Innocentsax/alx-backend-user-data","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;GET&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">hello_world</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; Base route for authentication service API &quot;&quot;&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">    <span class="pl-s1">msg</span> <span class="pl-c1">=</span> {<span class="pl-s">&quot;message&quot;</span>: <span class="pl-s">&quot;Bienvenue&quot;</span>}</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">msg</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/users&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;POST&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">register_user</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;Registers a new user if it does not exist before&quot;&quot;&quot;</span></div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative">        <span class="pl-s1">email</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;email&#039;</span>]</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative">        <span class="pl-s1">password</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;password&#039;</span>]</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">KeyError</span>:</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">400</span>)</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative">
</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">        <span class="pl-s1">user</span> <span class="pl-c1">=</span> <span class="pl-v">AUTH</span>.<span class="pl-en">register_user</span>(<span class="pl-s1">email</span>, <span class="pl-s1">password</span>)</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">ValueError</span>:</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative">        <span class="pl-k">return</span> <span class="pl-en">jsonify</span>({<span class="pl-s">&quot;message&quot;</span>: <span class="pl-s">&quot;email already registered&quot;</span>}), <span class="pl-c1">400</span></div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative">
</div></div></div><div class="child-of-line-21  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">    <span class="pl-s1">msg</span> <span class="pl-c1">=</span> {<span class="pl-s">&quot;email&quot;</span>: <span class="pl-s1">email</span>, <span class="pl-s">&quot;message&quot;</span>: <span class="pl-s">&quot;user created&quot;</span>}</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">msg</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/sessions&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;POST&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">log_in</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; Logs in a user and returns session ID &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative">        <span class="pl-s1">email</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;email&#039;</span>]</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative">        <span class="pl-s1">password</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;password&#039;</span>]</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">KeyError</span>:</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">400</span>)</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative">
</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative">    <span class="pl-k">if</span> <span class="pl-c1">not</span> <span class="pl-v">AUTH</span>.<span class="pl-en">valid_login</span>(<span class="pl-s1">email</span>, <span class="pl-s1">password</span>):</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">401</span>)</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">
</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative">    <span class="pl-s1">session_id</span> <span class="pl-c1">=</span> <span class="pl-v">AUTH</span>.<span class="pl-en">create_session</span>(<span class="pl-s1">email</span>)</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative">
</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">    <span class="pl-s1">msg</span> <span class="pl-c1">=</span> {<span class="pl-s">&quot;email&quot;</span>: <span class="pl-s1">email</span>, <span class="pl-s">&quot;message&quot;</span>: <span class="pl-s">&quot;logged in&quot;</span>}</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">    <span class="pl-s1">response</span> <span class="pl-c1">=</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">msg</span>)</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative">
</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative">    <span class="pl-s1">response</span>.<span class="pl-en">set_cookie</span>(<span class="pl-s">&quot;session_id&quot;</span>, <span class="pl-s1">session_id</span>)</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative">    <span class="pl-k">return</span> <span class="pl-s1">response</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/sessions&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;DELETE&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">log_out</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;Find the user with the requested session ID.</span></div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative"><span class="pl-s">    If the user exists destroy the session and redirect the user to GET /.</span></div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC65" class="react-file-line html-div" data-testid="code-cell" data-line-number="65" style="position:relative"><span class="pl-s">    If the user does not exist, respond with a 403 HTTP status.</span></div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC67" class="react-file-line html-div" data-testid="code-cell" data-line-number="67" style="position:relative">    <span class="pl-s1">session_id</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">cookies</span>.<span class="pl-en">get</span>(<span class="pl-s">&quot;session_id&quot;</span>, <span class="pl-c1">None</span>)</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC68" class="react-file-line html-div" data-testid="code-cell" data-line-number="68" style="position:relative">
</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC69" class="react-file-line html-div" data-testid="code-cell" data-line-number="69" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">session_id</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC70" class="react-file-line html-div" data-testid="code-cell" data-line-number="70" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC71" class="react-file-line html-div" data-testid="code-cell" data-line-number="71" style="position:relative">
</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC72" class="react-file-line html-div" data-testid="code-cell" data-line-number="72" style="position:relative">    <span class="pl-s1">user</span> <span class="pl-c1">=</span> <span class="pl-v">AUTH</span>.<span class="pl-en">get_user_from_session_id</span>(<span class="pl-s1">session_id</span>)</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC73" class="react-file-line html-div" data-testid="code-cell" data-line-number="73" style="position:relative">
</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC74" class="react-file-line html-div" data-testid="code-cell" data-line-number="74" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">user</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC75" class="react-file-line html-div" data-testid="code-cell" data-line-number="75" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC76" class="react-file-line html-div" data-testid="code-cell" data-line-number="76" style="position:relative">
</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC77" class="react-file-line html-div" data-testid="code-cell" data-line-number="77" style="position:relative">    <span class="pl-v">AUTH</span>.<span class="pl-en">destroy_session</span>(<span class="pl-s1">user</span>.<span class="pl-s1">id</span>)</div></div></div><div class="child-of-line-61  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC78" class="react-file-line html-div" data-testid="code-cell" data-line-number="78" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC79" class="react-file-line html-div" data-testid="code-cell" data-line-number="79" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">redirect</span>(<span class="pl-s">&#039;/&#039;</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC80" class="react-file-line html-div" data-testid="code-cell" data-line-number="80" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC82" class="react-file-line html-div" data-testid="code-cell" data-line-number="82" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/profile&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;GET&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC83" class="react-file-line html-div" data-testid="code-cell" data-line-number="83" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">profile</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC84" class="react-file-line html-div" data-testid="code-cell" data-line-number="84" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; If the user exist, respond with a 200 HTTP status and a JSON Payload</span></div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC85" class="react-file-line html-div" data-testid="code-cell" data-line-number="85" style="position:relative"><span class="pl-s">    Otherwise respond with a 403 HTTP status.</span></div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC86" class="react-file-line html-div" data-testid="code-cell" data-line-number="86" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC87" class="react-file-line html-div" data-testid="code-cell" data-line-number="87" style="position:relative">    <span class="pl-s1">session_id</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">cookies</span>.<span class="pl-en">get</span>(<span class="pl-s">&quot;session_id&quot;</span>, <span class="pl-c1">None</span>)</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC88" class="react-file-line html-div" data-testid="code-cell" data-line-number="88" style="position:relative">
</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC89" class="react-file-line html-div" data-testid="code-cell" data-line-number="89" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">session_id</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC90" class="react-file-line html-div" data-testid="code-cell" data-line-number="90" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC91" class="react-file-line html-div" data-testid="code-cell" data-line-number="91" style="position:relative">
</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC92" class="react-file-line html-div" data-testid="code-cell" data-line-number="92" style="position:relative">    <span class="pl-s1">user</span> <span class="pl-c1">=</span> <span class="pl-v">AUTH</span>.<span class="pl-en">get_user_from_session_id</span>(<span class="pl-s1">session_id</span>)</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC93" class="react-file-line html-div" data-testid="code-cell" data-line-number="93" style="position:relative">
</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC94" class="react-file-line html-div" data-testid="code-cell" data-line-number="94" style="position:relative">    <span class="pl-k">if</span> <span class="pl-s1">user</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC95" class="react-file-line html-div" data-testid="code-cell" data-line-number="95" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC96" class="react-file-line html-div" data-testid="code-cell" data-line-number="96" style="position:relative">
</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC97" class="react-file-line html-div" data-testid="code-cell" data-line-number="97" style="position:relative">    <span class="pl-s1">msg</span> <span class="pl-c1">=</span> {<span class="pl-s">&quot;email&quot;</span>: <span class="pl-s1">user</span>.<span class="pl-s1">email</span>}</div></div></div><div class="child-of-line-82  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC98" class="react-file-line html-div" data-testid="code-cell" data-line-number="98" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC99" class="react-file-line html-div" data-testid="code-cell" data-line-number="99" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">msg</span>), <span class="pl-c1">200</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC100" class="react-file-line html-div" data-testid="code-cell" data-line-number="100" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC102" class="react-file-line html-div" data-testid="code-cell" data-line-number="102" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/reset_password&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;POST&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC103" class="react-file-line html-div" data-testid="code-cell" data-line-number="103" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">reset_password</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC104" class="react-file-line html-div" data-testid="code-cell" data-line-number="104" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;If the email is not registered, respond with a 403 status code.</span></div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC105" class="react-file-line html-div" data-testid="code-cell" data-line-number="105" style="position:relative"><span class="pl-s">    Otherwise, generate a token and respond with a</span></div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC106" class="react-file-line html-div" data-testid="code-cell" data-line-number="106" style="position:relative"><span class="pl-s">    200 HTTP status and JSON Payload</span></div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC107" class="react-file-line html-div" data-testid="code-cell" data-line-number="107" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC108" class="react-file-line html-div" data-testid="code-cell" data-line-number="108" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC109" class="react-file-line html-div" data-testid="code-cell" data-line-number="109" style="position:relative">        <span class="pl-s1">email</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;email&#039;</span>]</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC110" class="react-file-line html-div" data-testid="code-cell" data-line-number="110" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">KeyError</span>:</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC111" class="react-file-line html-div" data-testid="code-cell" data-line-number="111" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC112" class="react-file-line html-div" data-testid="code-cell" data-line-number="112" style="position:relative">
</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC113" class="react-file-line html-div" data-testid="code-cell" data-line-number="113" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC114" class="react-file-line html-div" data-testid="code-cell" data-line-number="114" style="position:relative">        <span class="pl-s1">reset_token</span> <span class="pl-c1">=</span> <span class="pl-v">AUTH</span>.<span class="pl-en">get_reset_password_token</span>(<span class="pl-s1">email</span>)</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC115" class="react-file-line html-div" data-testid="code-cell" data-line-number="115" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">ValueError</span>:</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC116" class="react-file-line html-div" data-testid="code-cell" data-line-number="116" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC117" class="react-file-line html-div" data-testid="code-cell" data-line-number="117" style="position:relative">
</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC118" class="react-file-line html-div" data-testid="code-cell" data-line-number="118" style="position:relative">    <span class="pl-s1">msg</span> <span class="pl-c1">=</span> {<span class="pl-s">&quot;email&quot;</span>: <span class="pl-s1">email</span>, <span class="pl-s">&quot;reset_token&quot;</span>: <span class="pl-s1">reset_token</span>}</div></div></div><div class="child-of-line-102  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC119" class="react-file-line html-div" data-testid="code-cell" data-line-number="119" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC120" class="react-file-line html-div" data-testid="code-cell" data-line-number="120" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">msg</span>), <span class="pl-c1">200</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC121" class="react-file-line html-div" data-testid="code-cell" data-line-number="121" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC123" class="react-file-line html-div" data-testid="code-cell" data-line-number="123" style="position:relative"><span class="pl-en">@<span class="pl-s1">app</span>.<span class="pl-en">route</span>(<span class="pl-s">&#039;/reset_password&#039;</span>, <span class="pl-s1">methods</span><span class="pl-c1">=</span>[<span class="pl-s">&#039;PUT&#039;</span>])</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC124" class="react-file-line html-div" data-testid="code-cell" data-line-number="124" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">update_password</span>() <span class="pl-c1">-&gt;</span> <span class="pl-s1">str</span>:</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC125" class="react-file-line html-div" data-testid="code-cell" data-line-number="125" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; PUT /reset_password</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC126" class="react-file-line html-div" data-testid="code-cell" data-line-number="126" style="position:relative"><span class="pl-s">    Updates password with reset token</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC127" class="react-file-line html-div" data-testid="code-cell" data-line-number="127" style="position:relative"><span class="pl-s">    Return:</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC128" class="react-file-line html-div" data-testid="code-cell" data-line-number="128" style="position:relative"><span class="pl-s">        - 400 if bad request</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC129" class="react-file-line html-div" data-testid="code-cell" data-line-number="129" style="position:relative"><span class="pl-s">        - 403 if not valid reset token</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC130" class="react-file-line html-div" data-testid="code-cell" data-line-number="130" style="position:relative"><span class="pl-s">        - 200 and JSON Payload if valid</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC131" class="react-file-line html-div" data-testid="code-cell" data-line-number="131" style="position:relative"><span class="pl-s">    &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC132" class="react-file-line html-div" data-testid="code-cell" data-line-number="132" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC133" class="react-file-line html-div" data-testid="code-cell" data-line-number="133" style="position:relative">        <span class="pl-s1">email</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;email&#039;</span>]</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC134" class="react-file-line html-div" data-testid="code-cell" data-line-number="134" style="position:relative">        <span class="pl-s1">reset_token</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;reset_token&#039;</span>]</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC135" class="react-file-line html-div" data-testid="code-cell" data-line-number="135" style="position:relative">        <span class="pl-s1">new_password</span> <span class="pl-c1">=</span> <span class="pl-s1">request</span>.<span class="pl-s1">form</span>[<span class="pl-s">&#039;new_password&#039;</span>]</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC136" class="react-file-line html-div" data-testid="code-cell" data-line-number="136" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">KeyError</span>:</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC137" class="react-file-line html-div" data-testid="code-cell" data-line-number="137" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">400</span>)</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC138" class="react-file-line html-div" data-testid="code-cell" data-line-number="138" style="position:relative">
</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC139" class="react-file-line html-div" data-testid="code-cell" data-line-number="139" style="position:relative">    <span class="pl-k">try</span>:</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC140" class="react-file-line html-div" data-testid="code-cell" data-line-number="140" style="position:relative">        <span class="pl-v">AUTH</span>.<span class="pl-en">update_password</span>(<span class="pl-s1">reset_token</span>, <span class="pl-s1">new_password</span>)</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC141" class="react-file-line html-div" data-testid="code-cell" data-line-number="141" style="position:relative">    <span class="pl-k">except</span> <span class="pl-v">ValueError</span>:</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC142" class="react-file-line html-div" data-testid="code-cell" data-line-number="142" style="position:relative">        <span class="pl-en">abort</span>(<span class="pl-c1">403</span>)</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC143" class="react-file-line html-div" data-testid="code-cell" data-line-number="143" style="position:relative">
</div></div></div><div class="child-of-line-123  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC144" class="react-file-line html-div" data-testid="code-cell" data-line-number="144" style="position:relative">    <span class="pl-s1">msg</span> <span class="pl-c1">=</span> {<span class="pl-s">&quot;email&quot;</span>: <span class="pl-s1">email</span>, <span class="pl-s">&quot;message&quot;</span>: <span class="pl-s">&quot;Password updated&quot;</span>}</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC145" class="react-file-line html-div" data-testid="code-cell" data-line-number="145" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">jsonify</span>(<span class="pl-s1">msg</span>), <span class="pl-c1">200</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC146" class="react-file-line html-div" data-testid="code-cell" data-line-number="146" style="position:relative">
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC148" class="react-file-line html-div" data-testid="code-cell" data-line-number="148" style="position:relative"><span class="pl-k">if</span> <span class="pl-s1">__name__</span> <span class="pl-c1">==</span> <span class="pl-s">&quot;__main__&quot;</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC149" class="react-file-line html-div" data-testid="code-cell" data-line-number="149" style="position:relative">    <span class="pl-s1">app</span>.<span class="pl-en">run</span>(<span class="pl-s1">host</span><span class="pl-c1">=</span><span class="pl-s">&quot;0.0.0.0&quot;</span>, <span class="pl-s1">port</span><span class="pl-c1">=</span><span class="pl-s">&quot;5000&quot;</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
