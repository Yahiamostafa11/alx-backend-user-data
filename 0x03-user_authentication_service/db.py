...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>alx-backend-user-data/0x03-user_authentication_service/db.py at main · Innocentsax/alx-backend-user-data · GitHub</title>
  ...
  <meta name="request-id" content="C1E9:ADBA8:5BD197:5D5B1A:66F43F58" data-pjax-transient="true"/><meta name="html-safe-nonce" content="aad7d97e0ff11442d3cfa6f791664cfb91081de3cc2c326271b82dbad5fdae9d" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJDMUU5OkFEQkE4OjVCRDE5Nzo1RDVCMUE6NjZGNDNGNTgiLCJ2aXNpdG9yX2lkIjoiNjc3MTY1OTg3OTcyODAzNzcyMSIsInJlZ2lvbl9lZGdlIjoiZnJhIiwicmVnaW9uX3JlbmRlciI6ImZyYSJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="e244f75e0c103fc905bea26c670d950c9b3e12c041915c4ec47c84c22a02ff04" data-pjax-transient="true"/>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - alx-backend-user-data/0x03-user_authentication_service/db.py at main · Innocentsax/alx-backend-user-data">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py" />

      <meta name="twitter:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="alx-backend-user-data/0x03-user_authentication_service/db.py at main · Innocentsax/alx-backend-user-data" /><meta name="twitter:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  <meta property="og:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta property="og:image:alt" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="alx-backend-user-data/0x03-user_authentication_service/db.py at main · Innocentsax/alx-backend-user-data" /><meta property="og:url" content="https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py" /><meta property="og:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x03-user_authentication_service%2Fdb.py"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="a454e3250b5bff4aca86f5c816d4a35bdababbbd0a78e7a205f4fe23b9f8920b"
...
<qbsearch-input class="search-input" data-scope="repo:Innocentsax/alx-backend-user-data" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="wUWx3JYJIj8C8PGSWxpJR7VNsrTxuaKJ1_9h05LdASXpuxOLRXyW44US6kyEg-u-LWDH5IwoGRQuxi-yo6LOJw" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Innocentsax/alx-backend-user-data" data-current-org="" data-current-owner="Innocentsax" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-4e0c2c33-8a41-4d1c-8a29-f6fd2215f47d" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-4e0c2c33-8a41-4d1c-8a29-f6fd2215f47d" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="mC/1hWShtl03CGbghf15vgUJ3tKn/OJpt2Gv0capHkeDqeIvJUHiazRNrWo2tp6txWz+jZoGIfK3zjrEp29gmg==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="DLJzyctvy+GHQXRYnis6NtJALrOujGRiSolnpKM5okoYrf1G3cN4XEWpEydDJl8+fXH/GDuP8beGkSXBTQzIoA==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="xWGg4rIM03kJ6KDpouAPyUEMwRiqhRKWK2d8hkPMdRUhfOhir8hHICZEwY9Gf9eC/8ZuxAnTNfePlEHc2TH7CA==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-1a0a6142-418b-4e3f-bd71-31a248f16325" aria-labelledby="tooltip-81ef1169-7d98-458d-b82f-0b8e90cbc505" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-81ef1169-7d98-458d-b82f-0b8e90cbc505" for="icon-button-1a0a6142-418b-4e3f-bd71-31a248f16325" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="d3825e2633018bf666ae0767bbe9ed74d07a538286234632c8b0ea8641bd9f67" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-df2ef657-dbfc-4e25-8367-c09d23222db1" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

  </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="d023c944f98ae1f4023a800b5516c6e14517a563014fc779462fe106461c6395" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="dcf4318d0836d02405ff7a9967157c43eb700cffe58304b0bab3b2298a60989e" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-button" popovertarget="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-overlay" aria-controls="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-list" aria-haspopup="true" aria-labelledby="tooltip-7a761289-ea22-4ff2-ab7f-e0cd1a8bd25e" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-7a761289-ea22-4ff2-ab7f-e0cd1a8bd25e" for="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-overlay" anchor="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-button" id="action-menu-1ae918a2-8462-4bec-8656-bf9e181bfbda-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-b91dc737-8308-487b-a290-2c93e1f77065" href="/Innocentsax/alx-backend-user-data" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-80727b7f-5126-49eb-bd4e-77a0576ea8c5" href="/Innocentsax/alx-backend-user-data/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-3c498c91-3a68-4208-8caa-f62571c6ab66" href="/Innocentsax/alx-backend-user-data/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-4c71c391-e2e5-492f-b350-cd17887f1294" href="/Innocentsax/alx-backend-user-data/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-29e4a2a2-85f6-4416-80ed-04c463e156f3" href="/Innocentsax/alx-backend-user-data/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-270e0c24-f9b3-457e-bcd1-7b88c16e0483" href="/Innocentsax/alx-backend-user-data/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-5516c4e4-6a5d-4e6d-8812-2bd8b1504e10" href="/Innocentsax/alx-backend-user-data/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"0x03-user_authentication_service":{"items":[{"name":"README.md","path":"0x03-user_authentication_service/README.md","contentType":"file"},{"name":"app.py","path":"0x03-user_authentication_service/app.py","contentType":"file"},{"name":"auth.py","path":"0x03-user_authentication_service/auth.py","contentType":"file"},{"name":"db.py","path":"0x03-user_authentication_service/db.py","contentType":"file"},{"name":"main.py","path":"0x03-user_authentication_service/main.py","contentType":"file"},{"name":"user.py","path":"0x03-user_authentication_service/user.py","contentType":"file"}],"totalCount":6},"":{"items":[{"name":"0x00-personal_data","path":"0x00-personal_data","contentType":"directory"},{"name":"0x01-Basic_authentication","path":"0x01-Basic_authentication","contentType":"directory"},{"name":"0x02-Session_authentication","path":"0x02-Session_authentication","contentType":"directory"},{"name":"0x03-user_authentication_service","path":"0x03-user_authentication_service","contentType":"directory"},{"name":".DS_Store","path":".DS_Store","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Screenshot 2023-11-01 at 12.58.39 PM.png","path":"Screenshot 2023-11-01 at 12.58.39 PM.png","contentType":"file"}],"totalCount":8}},"fileTreeProcessingTime":3.4291259999999997,"foldersToFetch":[],"repo":{"id":712869884,"defaultBranch":"main","name":"alx-backend-user-data","ownerLogin":"Innocentsax","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-11-01T11:22:09.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/117287767?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1698839736.0","canEdit":false,"refType":"branch","currentOid":"465ee6ac460d1eb969bb744c6fa1c3dac0fc78d8"},"path":"0x03-user_authentication_service/db.py","currentUser":null,"blob":{"rawLines":["#!/usr/bin/env python3","\"\"\" Database for ORM \"\"\"","from sqlalchemy import create_engine","from sqlalchemy.ext.declarative import declarative_base","from sqlalchemy.orm import sessionmaker","from sqlalchemy.exc import InvalidRequestError","from sqlalchemy.orm.exc import NoResultFound","from typing import TypeVar","from user import Base, User","","","class DB:","    \"\"\" DB Class for Object Reational Mapping \"\"\"","","    def __init__(self):","        \"\"\" Constructor Method \"\"\"","        self._engine = create_engine(\"sqlite:///a.db\", echo=False)","        Base.metadata.drop_all(self._engine)","        Base.metadata.create_all(self._engine)","        self.__session = None","","    @property","    def _session(self):","        \"\"\" Session Getter Method \"\"\"","        if self.__session is None:","            DBSession = sessionmaker(bind=self._engine)","            self.__session = DBSession()","        return self.__session","","    def add_user(self, email: str, hashed_password: str) -\u003e User:","        \"\"\" Adds user to database","        Return: User Object","        \"\"\"","        user = User(email=email, hashed_password=hashed_password)","        self._session.add(user)","        self._session.commit()","","        return user","","    def find_user_by(self, **kwargs) -\u003e User:","        \"\"\" Finds user by key word args","        Return: First row found in the users table as filtered by kwargs","        \"\"\"","        if not kwargs:","            raise InvalidRequestError","","        column_names = User.__table__.columns.keys()","        for key in kwargs.keys():","            if key not in column_names:","                raise InvalidRequestError","","        user = self._session.query(User).filter_by(**kwargs).first()","","        if user is None:","            raise NoResultFound","","        return user","","    def update_user(self, user_id: int, **kwargs) -\u003e None:","        \"\"\" Update users attributes","        Returns: None","        \"\"\"","        user = self.find_user_by(id=user_id)","","        column_names = User.__table__.columns.keys()","        for key in kwargs.keys():","            if key not in column_names:","                raise ValueError","","        for key, value in kwargs.items():","            setattr(user, key, value)","","        self._session.commit()"],"stylingDirectives":[[{"s":0,"e":22,"c":"pl-c"}],[{"s":0,"e":24,"c":"pl-s"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":15,"c":"pl-s1"},{"s":16,"e
"c":"pl-s1"},{"s":21,"e":22,"c":"pl-c1"},{"s":23,"e":27,"c":"pl-v"},{"s":28,"e":37,"c":"pl-s1"},{"s":38,"e":45,"c":"pl-s1"},{"s":46,"e":50,"c":"pl-en"}],[{"s":8,"e":11,"c":"pl-k"},{"s":12,"e":15,"c":"pl-s1"},{"s":16,"e":18,"c":"pl-c1"},{"s":19,"e":25,"c":"pl-s1"},{"s":26,"e":30,"c":"pl-en"}],[{"s":12,"e":14,"c":"pl-k"},{"s":15,"e":18,"c":"pl-s1"},{"s":19,"e":22,"c":"pl-c1"},{"s":23,"e":25,"c":"pl-c1"},{"s":26,"e":38,"c":"pl-s1"}],[{"s":16,"e":21,"c":"pl-k"},{"s":22,"e":32,"c":"pl-v"}],[],[{"s":8,"e":11,"c":"pl-k"},{"s":12,"e":15,"c":"pl-s1"},{"s":17,"e":22,"c":"pl-s1"},{"s":23,"e":25,"c":"pl-c1"},{"s":26,"e":32,"c":"pl-s1"},{"s":33,"e":38,"c":"pl-en"}],[{"s":12,"e":19,"c":"pl-en"},{"s":20,"e":24,"c":"pl-s1"},{"s":26,"e":29,"c":"pl-s1"},{"s":31,"e":36,"c":"pl-s1"}],[],[{"s":8,"e":12,"c":"pl-s1"},{"s":13,"e":21,"c":"pl-s1"},{"s":22,"e":28,"c":"pl-en"}]],"colorizedLines":null,"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/Innocentsax/alx-backend-user-data/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":null},"displayName":"db.py","displayUrl":"https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py?raw=true","headerInfo":{"blobSize":"2.12 KB","deleteTooltip":"You must be signed in to make or propose changes","editTooltip":"You must be signed in to make or propose changes","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"0d707b7","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x03-user_authentication_service%2Fdb.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"73","truncatedSloc":"58"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/db.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/Innocentsax/alx-backend-user-data/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/Innocentsax/alx-backend-user-data/raw/refs/heads/main/0x03-user_authentication_service/db.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"DB","kind":"class","ident_start":336,"ident_end":338,"extent_start":330,"extent_end":2169,"fully_qualified_name":"DB","ident_utf16":{"start":{"line_number":11,"utf16_col":6},"end":{"line_number":11,"utf16_col":8}},"extent_utf16":{"start":{"line_number":11,"utf16_col":0},"end":{"line_number":72,"utf16_col":30}}},{"name":"__init__","kind":"function","ident_start":399,"ident_end":407,"extent_start":395,"extent_end":638,"fully_qualified_name":"DB.__init__","ident_utf16":{"start":{"line_number":14,"utf16_col":8},"end":{"line_number":14,"utf16_col":16}},"extent_utf16":{"start":{"line_number":14,"utf16_col":4},"end":{"line_number":19,"utf16_col":29}}},{"name":"_session","kind":"function","ident_start":662,"ident_end":670,"extent_start":658,"extent_end":877,"fully_qualified_name":"DB._session","ident_utf16":{"start":{"line_number":22,"utf16_col":8},"end":{"line_number":22,"utf16_col":16}},"extent_utf16":{"start":{"line_number":22,"utf16_col":4},"end":{"line_number":27,"utf16_col":29}}},{"name":"add_user","kind":"function","ident_start":887,"ident_end":895,"extent_start":883,"extent_end":1168,"fully_qualified_name":"DB.add_user","ident_utf16":{"start":{"line_number":29,"utf16_col":8},"end":{"line_number":29,"utf16_col":16}},"extent_utf16":{"start":{"line_number":29,"utf16_col":4},"end":{"line_number":37,"utf16_col":19}}},{"name":"find_user_by","kind":"function","ident_start":1178,"ident_end":1190,"extent_start":1174,"extent_end":1720,"fully_qualified_name":"DB.find_user_by","ident_utf16":{"start":{"line_number":39,"utf16_col":8},"end":{"line_number":39,"utf16_col":20}},"extent_utf16":{"start":{"line_number":39,"utf16_col":4},"end":{"line_number":56,"utf16_col":19}}},{"name":"update_user","kind":"function","ident_start":1730,"ident_end":1741,"extent_start":1726,"extent_end":2169,"fully_qualified_name":"DB.update_user","ident_utf16":{"start":{"line_number":58,"utf16_col":8},"end":{"line_number":58,"utf16_col":19}},"extent_utf16":{"start":{"line_number":58,"utf16_col":4},"end":{"line_number":72,"utf16_col":30}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/Innocentsax/alx-backend-user-data/branches":{"post":"W2rFjL7Zkp9AwFz225j9t3kP26kvIXLA62Jmnk82svBTbOSbDujKjLzlAog93yrhKQrwMxrSx1OnmQU-6W2ubA"},"/repos/preferences":{"post":"moMZ72r3V1Z73IOjZ3S3dKm9rDB9gZ9iWAMVwj57Buu4NglRLL9EvZD4Dt8VlWAoig01hjN3MDewdU-lGH5tWA"}}},"title":"alx-backend-user-data/0x03-user_authentication_service/db.py at main · Innocentsax/alx-backend-user-data","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative"><span class="pl-k">class</span> <span class="pl-v">DB</span>:</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative">    <span class="pl-s">&quot;&quot;&quot; DB Class for Object Reational Mapping &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">__init__</span>(<span class="pl-s1">self</span>):</div></div></div><div class="child-of-line-11 child-of-line-14  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative">        <span class="pl-s">&quot;&quot;&quot; Constructor Method &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-11 child-of-line-14  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_engine</span> <span class="pl-c1">=</span> <span class="pl-en">create_engine</span>(<span class="pl-s">&quot;sqlite:///a.db&quot;</span>, <span class="pl-s1">echo</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</div></div></div><div class="child-of-line-11 child-of-line-14  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative">        <span class="pl-v">Base</span>.<span class="pl-s1">metadata</span>.<span class="pl-en">drop_all</span>(<span class="pl-s1">self</span>.<span class="pl-s1">_engine</span>)</div></div></div><div class="child-of-line-11 child-of-line-14  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative">        <span class="pl-v">Base</span>.<span class="pl-s1">metadata</span>.<span class="pl-en">create_all</span>(<span class="pl-s1">self</span>.<span class="pl-s1">_engine</span>)</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">__session</span> <span class="pl-c1">=</span> <span class="pl-c1">None</span></div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative">    <span class="pl-en">@<span class="pl-s1">property</span></span></div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">_session</span>(<span class="pl-s1">self</span>):</div></div></div><div class="child-of-line-11 child-of-line-22  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative">        <span class="pl-s">&quot;&quot;&quot; Session Getter Method &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-11 child-of-line-22  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">self</span>.<span class="pl-s1">__session</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-11 child-of-line-22  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative">            <span class="pl-v">DBSession</span> <span class="pl-c1">=</span> <span class="pl-en">sessionmaker</span>(<span class="pl-s1">bind</span><span class="pl-c1">=</span><span class="pl-s1">self</span>.<span class="pl-s1">_engine</span>)</div></div></div><div class="child-of-line-11 child-of-line-22  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">            <span class="pl-s1">self</span>.<span class="pl-s1">__session</span> <span class="pl-c1">=</span> <span class="pl-v">DBSession</span>()</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative">        <span class="pl-k">return</span> <span class="pl-s1">self</span>.<span class="pl-s1">__session</span></div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">add_user</span>(<span class="pl-s1">self</span>, <span class="pl-s1">email</span>: <span class="pl-s1">str</span>, <span class="pl-s1">hashed_password</span>: <span class="pl-s1">str</span>) <span class="pl-c1">-&gt;</span> <span class="pl-v">User</span>:</div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">        <span class="pl-s">&quot;&quot;&quot; Adds user to database</span></div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative"><span class="pl-s">        Return: User Object</span></div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative"><span class="pl-s">        &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative">        <span class="pl-s1">user</span> <span class="pl-c1">=</span> <span class="pl-v">User</span>(<span class="pl-s1">email</span><span class="pl-c1">=</span><span class="pl-s1">email</span>, <span class="pl-s1">hashed_password</span><span class="pl-c1">=</span><span class="pl-s1">hashed_password</span>)</div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_session</span>.<span class="pl-en">add</span>(<span class="pl-s1">user</span>)</div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_session</span>.<span class="pl-en">commit</span>()</div></div></div><div class="child-of-line-11 child-of-line-29  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative">        <span class="pl-k">return</span> <span class="pl-s1">user</span></div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">find_user_by</span>(<span class="pl-s1">self</span>, <span class="pl-c1">**</span><span class="pl-s1">kwargs</span>) <span class="pl-c1">-&gt;</span> <span class="pl-v">User</span>:</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative">        <span class="pl-s">&quot;&quot;&quot; Finds user by key word args</span></div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative"><span class="pl-s">        Return: First row found in the users table as filtered by kwargs</span></div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative"><span class="pl-s">        &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative">        <span class="pl-k">if</span> <span class="pl-c1">not</span> <span class="pl-s1">kwargs</span>:</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative">            <span class="pl-k">raise</span> <span class="pl-v">InvalidRequestError</span></div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative">
</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative">        <span class="pl-s1">column_names</span> <span class="pl-c1">=</span> <span class="pl-v">User</span>.<span class="pl-s1">__table__</span>.<span class="pl-s1">columns</span>.<span class="pl-en">keys</span>()</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative">        <span class="pl-k">for</span> <span class="pl-s1">key</span> <span class="pl-c1">in</span> <span class="pl-s1">kwargs</span>.<span class="pl-en">keys</span>():</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative">            <span class="pl-k">if</span> <span class="pl-s1">key</span> <span class="pl-c1">not</span> <span class="pl-c1">in</span> <span class="pl-s1">column_names</span>:</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">                <span class="pl-k">raise</span> <span class="pl-v">InvalidRequestError</span></div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative">
</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative">        <span class="pl-s1">user</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-s1">_session</span>.<span class="pl-en">query</span>(<span class="pl-v">User</span>).<span class="pl-en">filter_by</span>(<span class="pl-c1">**</span><span class="pl-s1">kwargs</span>).<span class="pl-en">first</span>()</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">
</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">        <span class="pl-k">if</span> <span class="pl-s1">user</span> <span class="pl-c1">is</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative">            <span class="pl-k">raise</span> <span class="pl-v">NoResultFound</span></div></div></div><div class="child-of-line-11 child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative">        <span class="pl-k">return</span> <span class="pl-s1">user</span></div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative">
</div></div></div><div class="child-of-line-11  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative">    <span class="pl-k">def</span> <span class="pl-en">update_user</span>(<span class="pl-s1">self</span>, <span class="pl-s1">user_id</span>: <span class="pl-s1">int</span>, <span class="pl-c1">**</span><span class="pl-s1">kwargs</span>) <span class="pl-c1">-&gt;</span> <span class="pl-c1">None</span>:</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC60" class="react-file-line html-div" data-testid="code-cell" data-line-number="60" style="position:relative">        <span class="pl-s">&quot;&quot;&quot; Update users attributes</span></div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative"><span class="pl-s">        Returns: None</span></div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative"><span class="pl-s">        &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative">        <span class="pl-s1">user</span> <span class="pl-c1">=</span> <span class="pl-s1">self</span>.<span class="pl-en">find_user_by</span>(<span class="pl-s1">id</span><span class="pl-c1">=</span><span class="pl-s1">user_id</span>)</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative">
</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC65" class="react-file-line html-div" data-testid="code-cell" data-line-number="65" style="position:relative">        <span class="pl-s1">column_names</span> <span class="pl-c1">=</span> <span class="pl-v">User</span>.<span class="pl-s1">__table__</span>.<span class="pl-s1">columns</span>.<span class="pl-en">keys</span>()</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative">        <span class="pl-k">for</span> <span class="pl-s1">key</span> <span class="pl-c1">in</span> <span class="pl-s1">kwargs</span>.<span class="pl-en">keys</span>():</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC67" class="react-file-line html-div" data-testid="code-cell" data-line-number="67" style="position:relative">            <span class="pl-k">if</span> <span class="pl-s1">key</span> <span class="pl-c1">not</span> <span class="pl-c1">in</span> <span class="pl-s1">column_names</span>:</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC68" class="react-file-line html-div" data-testid="code-cell" data-line-number="68" style="position:relative">                <span class="pl-k">raise</span> <span class="pl-v">ValueError</span></div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC69" class="react-file-line html-div" data-testid="code-cell" data-line-number="69" style="position:relative">
</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC70" class="react-file-line html-div" data-testid="code-cell" data-line-number="70" style="position:relative">        <span class="pl-k">for</span> <span class="pl-s1">key</span>, <span class="pl-s1">value</span> <span class="pl-c1">in</span> <span class="pl-s1">kwargs</span>.<span class="pl-en">items</span>():</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC71" class="react-file-line html-div" data-testid="code-cell" data-line-number="71" style="position:relative">            <span class="pl-en">setattr</span>(<span class="pl-s1">user</span>, <span class="pl-s1">key</span>, <span class="pl-s1">value</span>)</div></div></div><div class="child-of-line-11 child-of-line-58  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC72" class="react-file-line html-div" data-testid="code-cell" data-line-number="72" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC73" class="react-file-line html-div" data-testid="code-cell" data-line-number="73" style="position:relative">        <span class="pl-s1">self</span>.<span class="pl-s1">_session</span>.<span class="pl-en">commit</span>()</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
