...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>alx-backend-user-data/0x03-user_authentication_service/user.py at main · Innocentsax/alx-backend-user-data · GitHub</title>
  ...
  <meta name="request-id" content="C1EC:129EC0:5BDCDC:5D660F:66F43F82" data-pjax-transient="true"/><meta name="html-safe-nonce" content="5fb6437a48f18d9a07a7e73f75dd2f2e58a853e0f33142f4e8a529cae0dd9935" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJDMUVDOjEyOUVDMDo1QkRDREM6NUQ2NjBGOjY2RjQzRjgyIiwidmlzaXRvcl9pZCI6IjM0MzY2OTgxNzE4NzY4NTE1ODYiLCJyZWdpb25fZWRnZSI6ImZyYSIsInJlZ2lvbl9yZW5kZXIiOiJmcmEifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="6768130f002688b37aa26b6656a7479831e6524cfef81425f3a6d9868697c2d3" data-pjax-transient="true"/>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - alx-backend-user-data/0x03-user_authentication_service/user.py at main · Innocentsax/alx-backend-user-data">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py" />

      <meta name="twitter:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="alx-backend-user-data/0x03-user_authentication_service/user.py at main · Innocentsax/alx-backend-user-data" /><meta name="twitter:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  <meta property="og:image" content="https://opengraph.githubassets.com/45a195bf55b8e1415bc88f40c8ca24a41b62a1a5843346b8f467a18e64410cb7/Innocentsax/alx-backend-user-data" /><meta property="og:image:alt" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="alx-backend-user-data/0x03-user_authentication_service/user.py at main · Innocentsax/alx-backend-user-data" /><meta property="og:url" content="https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py" /><meta property="og:description" content="Unlock PII protection with this comprehensive resource hub. Explore PII definitions, advanced logging techniques, bcrypt for security, and seamless database authentication.  💻🛡️ - Innocentsax/alx-b..." />
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FInnocentsax%2Falx-backend-user-data%2Fblob%2Fmain%2F0x03-user_authentication_service%2Fuser.py"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="bf7e2fcd0683be998fd150dcc8817675f3557f13fbcc8ef778d64ed5ffd74803"
...
<qbsearch-input class="search-input" data-scope="repo:Innocentsax/alx-backend-user-data" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="X4EM17JXuIyhchu3qz0jzltXljQIM6FL3hkl_Gmfe2qWgsyc4yF6MyEAzc0GiGeHhDnNT6L1twzR3qn5Oe8nZw" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Innocentsax/alx-backend-user-data" data-current-org="" data-current-owner="Innocentsax" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-aad3e769-f465-4c44-9eec-65c089661290" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-aad3e769-f465-4c44-9eec-65c089661290" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="IpH6IFagWCcrhMzKeSxzC16lqDhOGPlR/x9KsokMFjVSXIg5/DIJGZTnHsN63OyUa4W8i7esjxaKVcbO5vr27g==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="mkYM3F0SI5cFiPkcuXcZUR7Pb7bwysnH294Bqln4M6jlP+GXrF8IEznt+QLiYb0I/yD5bmX5mjbsYt0tgX/jTw==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="pJ3KGe6/IugzjmTbhyeQTGsU3GyQzDxk0extbIzkzSHA2LYv+PJvXOJg9s8jmrbovbsl+j3TRFLXQvUQ+Gtp/g==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-9b9feee9-cb08-4957-bdd9-3986ad4f873f" aria-labelledby="tooltip-701b9d8e-d293-42bf-8367-b81a38779113" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-701b9d8e-d293-42bf-8367-b81a38779113" for="icon-button-9b9feee9-cb08-4957-bdd9-3986ad4f873f" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="3fd33537684c444202ae2b982a2f45ef02a94c28a5f45af19bd5c3a17cbc7b65" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-79ede1f0-c10b-43b3-80f4-a7b00c3395a8" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

  </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="ad099d606b7b7310b190ab2df9e2ee423dfa197a0f101c452489420061923565" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FInnocentsax%2Falx-backend-user-data" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:712869884,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="4c5573ecfded97bc9cced18f1b7f7d23e00ae5238482e480c8b1f96c6dc4d3f1" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-sw btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-button" popovertarget="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-overlay" aria-controls="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-list" aria-haspopup="true" aria-labelledby="tooltip-3cf024d4-6f93-4c07-8f87-fee96154db8b" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-3cf024d4-6f93-4c07-8f87-fee96154db8b" for="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-overlay" anchor="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-button" id="action-menu-07fb6670-d13a-4c6e-ab25-fcab4465f3aa-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-de64dc29-90eb-4ad3-882a-c5149ac0337d" href="/Innocentsax/alx-backend-user-data" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-67bf42d8-4e55-430c-a80a-74b5e23399e4" href="/Innocentsax/alx-backend-user-data/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-fd58db34-4612-4942-9b8d-d28e98eed32e" href="/Innocentsax/alx-backend-user-data/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-80a9a3d1-49c6-4f4a-a698-c0739767b3cf" href="/Innocentsax/alx-backend-user-data/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-920e1893-4cca-4c2a-94e9-5f3cb89fee59" href="/Innocentsax/alx-backend-user-data/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-d4bdea82-eaa2-45ad-8293-8dc24616aad1" href="/Innocentsax/alx-backend-user-data/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-7d5e726f-8eb4-4bff-8f8b-c9718deb3e1b" href="/Innocentsax/alx-backend-user-data/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/Innocentsax/alx-backend-user-data/blob/main/0x03-user_authentication_service/user.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"0x03-user_authentication_service":{"items":[{"name":"README.md","path":"0x03-user_authentication_service/README.md","contentType":"file"},{"name":"app.py","path":"0x03-user_authentication_service/app.py","contentType":"file"},{"name":"auth.py","path":"0x03-user_authentication_service/auth.py","contentType":"file"},{"name":"db.py","path":"0x03-user_authentication_service/db.py","contentType":"file"},{"name":"main.py","path":"0x03-user_authentication_service/main.py","contentType":"file"},{"name":"user.py","path":"0x03-user_authentication_service/user.py","contentType":"file"}],"totalCount":6},"":{"items":[{"name":"0x00-personal_data","path":"0x00-personal_data","contentType":"directory"},{"name":"0x01-Basic_authentication","path":"0x01-Basic_authentication","contentType":"directory"},{"name":"0x02-Session_authentication","path":"0x02-Session_authentication","contentType":"directory"},{"name":"0x03-user_authentication_service","path":"0x03-user_authentication_service","contentType":"directory"},{"name":".DS_Store","path":".DS_Store","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"Screenshot 2023-11-01 at 12.58.39 PM.png","path":"Screenshot 2023-11-01 at 12.58.39 PM.png","contentType":"file"}],"totalCount":8}},"fileTreeProcessingTime":3.716141,"foldersToFetch":[],"repo":{"id":712869884,"defaultBranch":"main","name":"alx-backend-user-data","ownerLogin":"Innocentsax","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-11-01T11:22:09.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/117287767?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1698839736.0","canEdit":false,"refType":"branch","currentOid":"465ee6ac460d1eb969bb744c6fa1c3dac0fc78d8"},"path":"0x03-user_authentication_service/user.py","currentUser":null,"blob":{"rawLines":["#!/usr/bin/env python3","\"\"\"Class User for ORM\"\"\"","","from sqlalchemy import Column, Integer, String","from sqlalchemy.ext.declarative import declarative_base","Base = declarative_base()","","","class User(Base):","    \"\"\"Representation of a user \"\"\"","    __tablename__ = 'users'","    id = Column(Integer, primary_key=True)","    email = Column(String(250), nullable=False)","    hashed_password = Column(String(250), nullable=False)","    session_id = Column(String(250))","    reset_token = Column(String(250))"],"stylingDirectives":[[{"s":0,"e":22,"c":"pl-c"}],[{"s":0,"e":24,"c":"pl-s"}],[],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":15,"c":"pl-s1"},{"s":16,"e":22,"c":"pl-k"},{"s":23,"e":29,"c":"pl-v"},{"s":31,"e":38,"c":"pl-v"},{"s":40,"e":46,"c":"pl-v"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":15,"c":"pl-s1"},{"s":16,"e":19,"c":"pl-s1"},{"s":20,"e":31,"c":"pl-s1"},{"s":32,"e":38,"c":"pl-k"},{"s":39,"e":55,"c":"pl-s1"}],[{"s":0,"e":4,"c":"pl-v"},{"s":5,"e":6,"c":"pl-c1"},{"s":7,"e":23,"c":"pl-en"}],[],[],[{"s":0,"e":5,"c":"pl-k"},{"s":6,"e
extent_start":309,"extent_end":352,"fully_qualified_name":"User.email","ident_utf16":{"start":{"line_number":12,"utf16_col":4},"end":{"line_number":12,"utf16_col":9}},"extent_utf16":{"start":{"line_number":12,"utf16_col":4},"end":{"line_number":12,"utf16_col":47}}},{"name":"hashed_password","kind":"constant","ident_start":357,"ident_end":372,"extent_start":357,"extent_end":410,"fully_qualified_name":"User.hashed_password","ident_utf16":{"start":{"line_number":13,"utf16_col":4},"end":{"line_number":13,"utf16_col":19}},"extent_utf16":{"start":{"line_number":13,"utf16_col":4},"end":{"line_number":13,"utf16_col":57}}},{"name":"session_id","kind":"constant","ident_start":415,"ident_end":425,"extent_start":415,"extent_end":447,"fully_qualified_name":"User.session_id","ident_utf16":{"start":{"line_number":14,"utf16_col":4},"end":{"line_number":14,"utf16_col":14}},"extent_utf16":{"start":{"line_number":14,"utf16_col":4},"end":{"line_number":14,"utf16_col":36}}},{"name":"reset_token","kind":"constant","ident_start":452,"ident_end":463,"extent_start":452,"extent_end":485,"fully_qualified_name":"User.reset_token","ident_utf16":{"start":{"line_number":15,"utf16_col":4},"end":{"line_number":15,"utf16_col":15}},"extent_utf16":{"start":{"line_number":15,"utf16_col":4},"end":{"line_number":15,"utf16_col":37}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/Innocentsax/alx-backend-user-data/branches":{"post":"wfW53sygixE5G_gPL6D0zKdigN-s1XVz-_GzSQ1ZOyAA9Va-0VI6rwVG8247hf01Pn-3JG3g79oC2Io5_ZykSg"},"/repos/preferences":{"post":"QSj23w9TDw7fRqZOoLZVkG7Rn5aD9KSWbvlVfutTZaXBZogtCjNna2yPc5A3aIO_eaZ5wLEHRmnHE4bw8T2raA"}}},"title":"alx-backend-user-data/0x03-user_authentication_service/user.py at main · Innocentsax/alx-backend-user-data","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC9" class="react-file-line html-div" data-testid="code-cell" data-line-number="9" style="position:relative"><span class="pl-k">class</span> <span class="pl-v">User</span>(<span class="pl-v">Base</span>):</div></div></div><div class="child-of-line-8  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;Representation of a user &quot;&quot;&quot;</span></div></div></div><div class="child-of-line-8  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative">    <span class="pl-s1">__tablename__</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;users&#039;</span></div></div></div><div class="child-of-line-8  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative">    <span class="pl-s1">id</span> <span class="pl-c1">=</span> <span class="pl-v">Column</span>(<span class="pl-v">Integer</span>, <span class="pl-s1">primary_key</span><span class="pl-c1">=</span><span class="pl-c1">True</span>)</div></div></div><div class="child-of-line-8  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative">    <span class="pl-s1">email</span> <span class="pl-c1">=</span> <span class="pl-v">Column</span>(<span class="pl-v">String</span>(<span class="pl-c1">250</span>), <span class="pl-s1">nullable</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</div></div></div><div class="child-of-line-8  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative">    <span class="pl-s1">hashed_password</span> <span class="pl-c1">=</span> <span class="pl-v">Column</span>(<span class="pl-v">String</span>(<span class="pl-c1">250</span>), <span class="pl-s1">nullable</span><span class="pl-c1">=</span><span class="pl-c1">False</span>)</div></div></div><div class="child-of-line-8  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative">    <span class="pl-s1">session_id</span> <span class="pl-c1">=</span> <span class="pl-v">Column</span>(<span class="pl-v">String</span>(<span class="pl-c1">250</span>))</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative">    <span class="pl-s1">reset_token</span> <span class="pl-c1">=</span> <span class="pl-v">Column</span>(<span class="pl-v">String</span>(<span class="pl-c1">250</span>))</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
